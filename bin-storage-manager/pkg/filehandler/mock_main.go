...
func (m *MockFileHandler) Create(ctx context.Context, customerID, ownerID uuid.UUID, referenceType file.ReferenceType, referenceID uuid.UUID, fileType file.Type, name, detail, filename, bucketName, filepath string) (*file.File, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, customerID, ownerID, referenceType, referenceID, fileType, name, detail, filename, bucketName, filepath)
...
func (mr *MockFileHandlerMockRecorder) Create(ctx, customerID, ownerID, referenceType, referenceID, fileType, name, detail, filename, bucketName, filepath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockFileHandler)(nil).Create), ctx, customerID, ownerID, referenceType, referenceID, fileType, name, detail, filename, bucketName, filepath)
}

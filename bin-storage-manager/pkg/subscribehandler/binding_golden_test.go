...
// Test_topicPatterns_golden pins the EXACT bind set of storage-manager on the global topic
...
func Test_topicPatterns_golden(t *testing.T) {
	...
	// design §5: storage-manager binds exactly 2 patterns.
...
// Test_fanoutUnbindTargets_golden pins the fanout exchanges storage-manager unbinds after
// a fully successful topic bind (VOIP-1406). This is the FULL subscribeTargets set wired
// in cmd/storage-manager: the single customer-manager fanout event exchange.

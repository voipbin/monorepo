...
func (h *subscribeHandler) Run() error {
	...
	go func() {
		if errConsume := h.sockHandler.ConsumeMessage(context.Background(), h.subscribeQueue, string(commonoutline.ServiceNameStorageManager), false, false, false, 10, h.processEventRun); errConsume != nil {

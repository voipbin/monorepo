...
2. Set `Metadata.ContactCaseID = case_id` on the resolved Conversation via `ConversationUpdateMetadata` (§4.4's existing RPC, not a new one) — applies whether the Conversation was just found or just created.

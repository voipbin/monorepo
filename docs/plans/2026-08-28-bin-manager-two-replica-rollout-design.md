...
| contact | **done (VOIP-1440; deploy verification pending)** | GetOrCreate/peerlock confirmed dead code (VOIP-1439); standard scale pattern applied, no code change needed |

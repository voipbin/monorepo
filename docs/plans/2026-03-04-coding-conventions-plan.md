# Coding Conventions Document Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Create a comprehensive `docs/coding-conventions.md` that codifies all coding conventions (documented and implicit) from the VoIPbin monorepo, then update root CLAUDE.md to reference it and fix contradictions in supplementary docs.

**Architecture:** Documentation-only change. A single new file `docs/coding-conventions.md` with 15 sections covering every coding convention. Root `CLAUDE.md` updated to reference it and remove duplicated inline conventions. Two supplementary docs (`database-patterns-checklist.md`, `reference.md`) patched to fix contradictions.

**Tech Stack:** Markdown documentation, Git

**Working Directory:** `~/gitvoipbin/monorepo/.worktrees/NOJIRA-Add-coding-conventions-document/`

**Reference Design:** `docs/plans/2026-03-04-coding-conventions-design.md`

---

### Task 1: Write Sections 1-3 of coding-conventions.md (Structure, Naming, Imports)

**Files:**
- Create: `docs/coding-conventions.md`

**Step 1: Create the file with document header and Sections 1-3**

Write `docs/coding-conventions.md` with the following content:
...
Run: `wc -l docs/coding-conventions.md`
Expected: ~250-300 lines

**Step 3: Commit sections 1-3**

```bash
cd ~/gitvoipbin/monorepo/.worktrees/NOJIRA-Add-coding-conventions-document
git add docs/coding-conventions.md docs/plans/2026-03-04-coding-conventions-design.md docs/plans/2026-03-04-coding-conventions-plan.md
git commit -m "NOJIRA-Add-coding-conventions-document

Add coding conventions document with sections 1-3 (structure, naming, imports)
plus design document and implementation plan.

- docs: Add docs/coding-conventions.md with Package Structure, Naming Conventions, Import Ordering
- docs: Add design document for coding conventions consolidation
- docs: Add implementation plan"
```

---

### Task 2: Write Sections 4-5 (Error Handling, Logging)

**Files:**
- Modify: `docs/coding-conventions.md`

**Step 1: Append Sections 4-5 to the file**

Append to `docs/coding-conventions.md`:
...
**Step 2: Commit sections 4-5**

```bash
git add docs/coding-conventions.md
git commit -m "NOJIRA-Add-coding-conventions-document

Add error handling and logging convention sections.

- docs: Add Section 4 (Error Handling) - sentinel errors, wrapping, log-then-return
- docs: Add Section 5 (Logging) - function-scoped logger, levels, structured logging"
```

---

### Task 3: Write Sections 6-7 (Model Definitions, Database Patterns)

**Files:**
- Modify: `docs/coding-conventions.md`

**Step 1: Append Sections 6-7 to the file**
...
**Step 2: Commit sections 6-7**

```bash
git add docs/coding-conventions.md
git commit -m "NOJIRA-Add-coding-conventions-document

Add model definitions and database patterns convention sections.

- docs: Add Section 6 (Model Definitions) - Identity, db tags, Field type, WebhookMessage
- docs: Add Section 7 (Database Patterns) - Squirrel, CRUD, empty slices, cache-aside, pagination"
```

---

### Task 4: Write Sections 8-9 (Handler Architecture, Inter-Service Communication)

**Files:**
- Modify: `docs/coding-conventions.md`

**Step 1: Append Sections 8-9 to the file**
...
**Step 2: Commit sections 8-9**

```bash
git add docs/coding-conventions.md
git commit -m "NOJIRA-Add-coding-conventions-document

Add handler architecture and inter-service communication convention sections.

- docs: Add Section 8 (Handler Architecture) - interface pattern, two-layer split, get-after-write
- docs: Add Section 9 (Inter-Service Communication) - RPC, routing, queue naming"
```

---

### Task 5: Write Sections 10-12 (API, Events, Configuration)

**Files:**
- Modify: `docs/coding-conventions.md`

**Step 1: Append Sections 10-12 to the file**
...
**Step 2: Commit sections 10-12**

```bash
git add docs/coding-conventions.md
git commit -m "NOJIRA-Add-coding-conventions-document

Add API, event publishing, and configuration convention sections.

- docs: Add Section 10 (API & External Interfaces) - atomic responses, servicehandler, filters
- docs: Add Section 11 (Event Publishing) - webhooks, fire-and-forget, event handler returns
- docs: Add Section 12 (Configuration) - Cobra/Viper pattern, env binding"
```

---

### Task 6: Write Sections 13-15 (Testing, Metrics, Security)

**Files:**
- Modify: `docs/coding-conventions.md`

**Step 1: Append Sections 13-15 to the file**
...
**Step 2: Commit sections 13-15**

```bash
git add docs/coding-conventions.md
git commit -m "NOJIRA-Add-coding-conventions-document

Add testing, metrics, and security convention sections.

- docs: Add Section 13 (Testing) - table-driven tests, mocks, assertions, gomock patterns
- docs: Add Section 14 (Prometheus Metrics) - registration, name collision avoidance
- docs: Add Section 15 (Security) - XSS, tokens, enumeration, guest agent, validation"
```

---

### Task 7: Update root CLAUDE.md to reference conventions doc

**Files:**
- Modify: `CLAUDE.md` (root)

**Step 1: Add reference in Code Quality section**

In `CLAUDE.md`, find the "## Code Quality" section and replace the opening paragraph with:
...
**Step 2: Add a cross-reference in the overview section**

After the "Key Characteristics" list in the Overview section, add:
...
Update root CLAUDE.md to reference the new coding conventions document.

- docs: Add prominent reference to coding-conventions.md in Code Quality section
- docs: Add key documentation links in Overview section"
```

---

### Task 8: Fix contradictions in supplementary docs

**Files:**
- Modify: `docs/database-patterns-checklist.md` (lines 238-276)
- Modify: `docs/reference.md` (lines 152-283)

**Step 1: Fix database-patterns-checklist.md**

Replace the "Scanning Results" section (lines 238-276) that shows manual `rows.Scan()` with the correct `commondatabasehandler.ScanRow()` pattern:

Find lines 238-276 (the "## Scanning Results" section) and replace with:
...
**Step 2: Fix reference.md duplication**

Replace the "Logging Standards" subsection (lines 152-283) in `docs/reference.md` with a link to the conventions doc:
...
```bash
git add docs/database-patterns-checklist.md docs/reference.md
git commit -m "NOJIRA-Add-coding-conventions-document

Fix contradictions in supplementary docs and deduplicate content.

- docs: Replace manual rows.Scan() examples with commondatabasehandler.ScanRow() in database-patterns-checklist.md
- docs: Replace duplicated logging/naming sections in reference.md with links to coding-conventions.md"
```
...
**Step 1: Review the full conventions document**
...
Run: `grep -o '\[.*\](.*\.md.*)' docs/coding-conventions.md | head -20`
...
**Step 4: Fetch main and check for conflicts**
...
Expected: No conflicts (documentation-only changes to new files or rarely-modified docs).

**Step 5: Push and create PR**

```bash
git push -u origin NOJIRA-Add-coding-conventions-document
```

Then create PR:

```bash
gh pr create --title "NOJIRA-Add-coding-conventions-document" --body "$(cat <<'EOF'
Add comprehensive coding conventions document and update documentation references
to establish a single authoritative source for all coding patterns.

- docs: Create docs/coding-conventions.md with 15 sections covering all coding conventions
- docs: Add design document and implementation plan
- docs: Update root CLAUDE.md to reference the conventions document prominently
- docs: Fix rows.Scan() contradiction in database-patterns-checklist.md
- docs: Deduplicate logging/naming content in reference.md with links to conventions doc
EOF
)"
```

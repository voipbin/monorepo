...
| File | Description |
|---|---|
| [architecture-deep-dive.md](architecture-deep-dive.md) | 30+ service catalog by category (call/media, AI, queue/routing, customer/agent, campaign, messaging, infrastructure), RabbitMQ RPC pattern, queue naming, configuration management, package layout, key dependencies, and Kubernetes deployment requirements |

...
**🚨 CRITICAL: If you make ANY changes to `bin-common-handler`, you MUST update ALL 35 services in the monorepo.**
...
```bash
# From monorepo root, update all 35 services
...
**All services depend on bin-common-handler** (all 35 projects):

...
// func (h *streamingHandler) AddMessageTotal(ctx context.Context, streamingID uuid.UUID, messageID uuid.UUID, message string) (*streaming.Streaming, error) {
// 	h.muStreaming.Lock()
// 	defer h.muStreaming.Unlock()
...
// 		return nil, fmt.Errorf("message ID mismatch. streaming_id: %s, current_message_id: %s, request_message_id: %s", streamingID, res.MessageID, messageID)
// 	}

// 	res.MessageTotal += message
// 	return res, nil
// }

// func (h *streamingHandler) AddMessagePlayed(ctx context.Context, streamingID uuid.UUID, messageID uuid.UUID, message string) (*streaming.Streaming, error) {
// 	h.muStreaming.Lock()
// 	defer h.muStreaming.Unlock()
...
// 	res.MessagePlayed += message
// 	return res, nil
// }

// func (h *streamingHandler) SetMessageFinish(ctx context.Context, streamingID uuid.UUID, messageID uuid.UUID) (*streaming.Streaming, error) {
// 	h.muStreaming.Lock()
// 	defer h.muStreaming.Unlock()

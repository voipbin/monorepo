...
func (m *MockStreamingHandler) Say(ctx context.Context, id uuid.UUID, text string) error {
	m.ctrl.T.Helper()
...
func (mr *MockStreamingHandlerMockRecorder) Say(ctx, id, text any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
func (h *activeflowHandler) actionHandleGotoLoop(ctx context.Context, af *activeflow.Activeflow, act *action.Action, opt *action.OptionGoto) error {
	...
	// find action
	_, orgAction, err := h.stackHandler.GetAction(af.StackMap, af.CurrentStackID, act.ID, false)
	if err != nil {
	...
	// find goto action
	targetStackID, targetAction, err := h.stackHandler.GetAction(af.StackMap, af.CurrentStackID, opt.TargetID, false)
	if err != nil {
...
func (h *activeflowHandler) actionHandleConditionCallDigits(ctx context.Context, af *activeflow.Activeflow) error {
	...
	targetStackID, targetAction, err := h.stackHandler.GetAction(af.StackMap, af.CurrentStackID, opt.FalseTargetID, false)
	if err != nil {
...
func (h *activeflowHandler) actionHandleQueueJoin(ctx context.Context, af *activeflow.Activeflow) error {
	...
	exitStackID, exitAction := h.stackHandler.GetNextAction(af.StackMap, af.CurrentStackID, &af.CurrentAction, false)
...
func (h *activeflowHandler) actionHandleBranch(ctx context.Context, af *activeflow.Activeflow) error {
	...
	targetStackID, targetAction, err := h.stackHandler.GetAction(af.StackMap, af.CurrentStackID, targetID, false)
	if err != nil {

...
func (m *MockActiveflowHandler) Create(ctx context.Context, id, customerID uuid.UUID, referenceType activeflow.ReferenceType, referenceID, flowID uuid.UUID) (*activeflow.Activeflow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, id, customerID, referenceType, referenceID, flowID)
	ret0, _ := ret[0].(*activeflow.Activeflow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockActiveflowHandlerMockRecorder) Create(ctx, id, customerID, referenceType, referenceID, flowID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockActiveflowHandler)(nil).Create), ctx, id, customerID, referenceType, referenceID, flowID)
}

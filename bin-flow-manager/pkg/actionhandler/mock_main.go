...
//
//	mockgen -package actionhandler -destination ./mock_main.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockActionHandlerMockRecorder) ActionFetchGet(act, activeflowID, referenceID any) *gomock.Call {
...
func (mr *MockActionHandlerMockRecorder) GenerateFlowActions(ctx, actions any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActionHandlerMockRecorder) ValidateActions(actions any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

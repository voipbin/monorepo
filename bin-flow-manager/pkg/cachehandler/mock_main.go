...
func (mr *MockCacheHandlerMockRecorder) ActiveflowGet(ctx, id any) *gomock.Call {
...
func (mr *MockCacheHandlerMockRecorder) ActiveflowGetWithLock(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) ActiveflowReleaseLock(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) ActiveflowSet(ctx, cf any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) FlowDel(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) FlowGet(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) VariableGet(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) VariableSet(ctx, t any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

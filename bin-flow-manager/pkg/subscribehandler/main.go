...
func (h *subscribeHandler) Run() error {
	...
	go func() {
		for {
			if errConsume := h.sockHandler.ConsumeMessage(h.subscribeQueue, string(commonoutline.ServiceNameFlowManager), false, false, false, 10, h.processEventRun); errConsume != nil {

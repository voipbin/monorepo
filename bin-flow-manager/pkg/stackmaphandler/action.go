...
func (h *stackHandler) GetNextAction(stackMap map[uuid.UUID]*stack.Stack, currentStackID uuid.UUID, currentActionID uuid.UUID, relaseStack bool) (uuid.UUID, *action.Action) {

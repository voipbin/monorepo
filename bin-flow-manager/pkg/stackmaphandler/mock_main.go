...
func (m *MockStackmapHandler) GetNextAction(stackMap map[uuid.UUID]*stack.Stack, currentStackID, currentActionID uuid.UUID, relaseStack bool) (uuid.UUID, *action.Action) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNextAction", stackMap, currentStackID, currentActionID, relaseStack)
	ret0, _ := ret[0].(uuid.UUID)
	ret1, _ := ret[1].(*action.Action)
	return ret0, ret1
}
...
func (mr *MockStackmapHandlerMockRecorder) GetNextAction(stackMap, currentStackID, currentActionID, relaseStack any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNextAction", reflect.TypeOf((*MockStackmapHandler)(nil).GetNextAction), stackMap, currentStackID, currentActionID, relaseStack)
}

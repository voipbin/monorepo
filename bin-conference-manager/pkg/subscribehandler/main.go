...
// topicPatterns is the ruled bind set of conference-manager on the global topic exchange
...
// set wired in cmd/conference-manager. The fanout QueueSubscribe calls in Run() stay
// until VOIP-1407 as the rollback/degrade surface.
...
func (h *subscribeHandler) Run() error {
	...
	go func() {
		if errConsume := h.sockHandler.ConsumeMessage(context.Background(), h.subscribeQueue, "conference-manager", false, false, false, 10, h.processEventRun); errConsume != nil {

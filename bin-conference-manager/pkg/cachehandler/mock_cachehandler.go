...
func (mr *MockCacheHandlerMockRecorder) ConferenceGet(ctx, id any) *gomock.Call {
...
func (mr *MockCacheHandlerMockRecorder) ConferencecallGet(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) ConferencecallGetByReferenceID(ctx, referenceID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

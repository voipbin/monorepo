...
//
//	mockgen -package conferencecallhandler -destination ./mock_main.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockConferencecallHandlerMockRecorder) Get(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConferencecallHandlerMockRecorder) GetByReferenceID(ctx, referenceID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConferencecallHandlerMockRecorder) HealthCheck(ctx, id, retryCount any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConferencecallHandlerMockRecorder) Joined(ctx, cc any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockConferencecallHandler) List(ctx context.Context, size uint64, token string, filters map[conferencecall.Field]any) ([]*conferencecall.Conferencecall, error) {
	m.ctrl.T.Helper()
...
func (mr *MockConferencecallHandlerMockRecorder) List(ctx, size, token, filters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockConferencecallHandler)(nil).List), ctx, size, token, filters)
}
...
func (mr *MockConferencecallHandlerMockRecorder) Terminate(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConferencecallHandlerMockRecorder) Terminated(ctx, cc any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

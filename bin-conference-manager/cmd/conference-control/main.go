...
func initConferenceHandler(sqlDB *sql.DB, cache cachehandler.CacheHandler) (conferencehandler.ConferenceHandler, error) {
	...
	notifyHandler := notifyhandler.NewNotifyHandler(sockHandler, reqHandler, commonoutline.QueueNameConferenceEvent, serviceName, notifyhandler.WithGlobalTopicPublish())

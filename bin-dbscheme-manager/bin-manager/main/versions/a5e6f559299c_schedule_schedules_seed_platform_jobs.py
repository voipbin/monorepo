"""schedule_schedules_seed_platform_jobs

Revision ID: a5e6f559299c
Revises: c07b40884361
Create Date: 2026-08-01 14:47:50.564470

Seeds the three platform housekeeping schedules for
bin-schedule-manager (VOIP-1283). See
docs/plans/2026-08-01-bin-schedule-manager-design.md §8.
...
revision = 'a5e6f559299c'
down_revision = 'c07b40884361'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.execute("""
        INSERT INTO schedule_schedules (
            ...
            'rpc',
            '0 2 * * *',
            'bin-manager.schedule-manager.request',
            '/v1/backups',
            'POST',
            'application/json',
            '{}',
    ...
    op.execute("""
        INSERT INTO schedule_schedules (
            ...
            UNHEX('00000000000000000000000000000000'),
            'execution-retention',
            'Prune schedule execution audit rows past retention',
            'rpc',
            '30 2 * * *',
            'bin-manager.schedule-manager.request',
            '/v1/executions/prune',

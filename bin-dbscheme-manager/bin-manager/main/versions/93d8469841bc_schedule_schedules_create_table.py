"""schedule_schedules_create_table

Revision ID: 93d8469841bc
Revises: 27a91e200854
Create Date: 2026-08-01 14:47:50.065704

Creates the schedule_schedules table for bin-schedule-manager
...
def upgrade():
    op.execute("""
        CREATE TABLE schedule_schedules (
            ...
            INDEX idx_schedule_schedules_customer_name (customer_id, name),   -- non-unique, lookup only
            INDEX idx_schedule_schedules_next_run (enabled, tm_next_run)      -- due-scan
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
    """)


def downgrade():
    op.execute("""DROP TABLE IF EXISTS schedule_schedules;""")

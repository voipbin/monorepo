...
// currentcalls
const CurrentcallsDetail = React.lazy(() => import('./views/currentcalls/detail'))
...
const routes = [
  ...
  { path: '/resources/currentcalls/detail', name: 'CurrentcallsDetail', element: CurrentcallsDetail },

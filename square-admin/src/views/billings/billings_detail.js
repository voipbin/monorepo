...
const BillingsDetail = () => {
  console.log("BillingsDetail");

  const [buttonDisable, setButtonDisable] = useState(false);
  const navigate = useNavigate();

  const ref_id = useRef(null);
  const ref_account_id = useRef(null);
  ...
  const GetDetail = () => {
    ...
    const tmp = localStorage.getItem("billings");
          ...
          <CCol xs={12}>
            <CCard className="mb-4">
              ...
              <CCardBody>
                ...
                <CRow>
                  <CFormLabel className="col-sm-2 col-form-label"><b>Account ID</b></CFormLabel>
                  <CCol className="mb-3 align-items-auto">
                    <CFormInput
                      ref={ref_account_id}
                      type="text"
                ...
                <CRow>
                  <CFormLabel htmlFor="colFormLabelSm" className="col-sm-2 col-form-label"><b>Cost Per Unit(USD)</b></CFormLabel>
                  <CCol className="mb-3 align-items-auto">
                    <CFormInput
                      type="text"
                      id="colFormLabelSm"
                      defaultValue={detailData.cost_per_unit}
                      readOnly plainText
                    />
                  </CCol>

                  <CFormLabel htmlFor="colFormLabelSm" className="col-sm-2 col-form-label"><b>Billing Unit Count</b></CFormLabel>
                  <CCol className="mb-3 align-items-auto">
                    <CFormInput
                      type="text"
                      id="colFormLabelSm"
                      defaultValue={detailData.billing_unit_count}
                      readOnly plainText
                    />
                  </CCol>
                </CRow>
                ...
                <CRow>
                  <CFormLabel htmlFor="colFormLabelSm" className="col-sm-2 col-form-label"><b>Cost Total(USD)</b></CFormLabel>
                  <CCol className="mb-3 align-items-auto">
                    <CFormInput
                      type="text"
                      id="colFormLabelSm"
                      defaultValue={detailData.cost_total}
                      readOnly plainText
                    />
                  </CCol>
                </CRow>
                ...
                <CRow>
                  <CFormLabel htmlFor="colFormLabelSm" className="col-sm-2 col-form-label"><b>Billing Start Timestamp</b></CFormLabel>
                  <CCol className="mb-3 align-items-auto">
                    <CFormInput
                      type="text"
                      id="colFormLabelSm"
                      defaultValue={detailData.tm_billing_start}
                      readOnly plainText
                    />
                  </CCol>

                  <CFormLabel htmlFor="colFormLabelSm" className="col-sm-2 col-form-label"><b>Billing End Timestamp</b></CFormLabel>
                  <CCol>
                    <CFormInput
                      type="text"
                      id="colFormLabelSm"
                      defaultValue={detailData.tm_billing_end}
                      readOnly plainText
                    />
                  </CCol>
                </CRow>
  ...
  const navigateList = () => {
    const target = "/resources/billings/billings_list";

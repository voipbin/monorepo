...
- `active_ai_id` — UUID of the AI configuration that was active when the message was created; `uuid.Nil` for user-originated messages in team sessions where the active AI is unknown

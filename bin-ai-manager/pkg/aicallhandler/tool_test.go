...
func Test_toolHandleGetAIcallMessages(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectRes: &messageContent{
				Result:       "success",
				Message:      `[{"id":"05a8c208-d46b-11f0-b4ce-3f2afb9cba1b","customer_id":"00000000-0000-0000-0000-000000000000","aicall_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","tm_create":null,"tm_delete":null},{"id":"05e43a7c-d46b-11f0-ad07-e7fb818d821b","customer_id":"00000000-0000-0000-0000-000000000000","aicall_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","tm_create":null,"tm_delete":null}]`,
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			mockMessage.EXPECT().List(ctx, uint64(1000), gomock.Any(), gomock.Any()).Return(tt.responseMessages, nil)

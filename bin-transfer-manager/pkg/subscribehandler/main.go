...
// set wired in cmd/transfer-manager (the call-manager event exchange only). The fanout
// QueueSubscribe calls in Run() stay until VOIP-1407 as the rollback/degrade surface.

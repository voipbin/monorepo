...
//
//	mockgen -package transferhandler -destination ./mock_main.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockTransferHandlerMockRecorder) GetByGroupcallID(ctx, groupcallID any) *gomock.Call {
...
func (mr *MockTransferHandlerMockRecorder) GetByTransfererCallID(ctx, transfererCallID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransferHandlerMockRecorder) ServiceStart(ctx, transferType, TransfererCallID, transfereeAddresses any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransferHandlerMockRecorder) TransfereeHangup(ctx, tr, gc any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransferHandlerMockRecorder) TransfererHangup(ctx, tr, transfererCall any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

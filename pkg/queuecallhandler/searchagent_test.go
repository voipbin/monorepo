...
func TestSearchAgentWithWrongStatus(t *testing.T) {
	mc := gomock.NewController(t)
	defer mc.Finish()
...
func TestSearchAgentWithWrongAgents(t *testing.T) {
	mc := gomock.NewController(t)
	defer mc.Finish()
...
func TestSearchAgentWithWrongRoutingMethod(t *testing.T) {
	mc := gomock.NewController(t)
	defer mc.Finish()
...
func TestSearchAgentWithAgentDialFailure(t *testing.T) {
	mc := gomock.NewController(t)
	defer mc.Finish()

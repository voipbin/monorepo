...
func TestProcessV1StreamingsPost(t *testing.T) {
	...
	tests := []test{
		{
			...
			&rabbitmqhandler.Request{
				...
				Data:     []byte(`{"reference_id":"02c7a132-0be1-11ec-ba15-ebb66c983fba","customer_id":"45afd578-7ffe-11ec-9430-3bdf65368563","type":"call","language":"en-US","webhook_uri":"test.com:8080","webhook_method":"post"}`),
			},
			&transcribe.Transcribe{
				...
				Language:      "en-US",
				WebhookURI:    "test.com:8080",
				WebhookMethod: "post",
			},
			&rabbitmqhandler.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"5f8cbc4e-0be2-11ec-8cf2-7f5531d8f428","customer_id":"45afd578-7ffe-11ec-9430-3bdf65368563","type":"call","reference_id":"02c7a132-0be1-11ec-ba15-ebb66c983fba","host_id":"3a02f50c-0be6-11ec-9fa7-8792d3dfbd60","language":"en-US","webhook_uri":"test.com:8080","webhook_method":"post","transcripts":null,"tm_create":"","tm_update":"","tm_delete":""}`),
			},
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockTranscribe.EXPECT().StreamingTranscribeStart(gomock.Any(), tt.customerID, tt.referenceID, tt.transcribeType, tt.language, tt.webhookURI, tt.webhookMethod).Return(tt.transcribeRes, nil)

...
func Test_v1MessagechatroomsGet(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			&rabbitmqhandler.Request{
				URI:      "/v1/messagechatrooms?page_token=2020-10-10T03:30:17.000000&page_size=10&chatroom_id=d260ac86-3507-11ed-9594-cfe9c21b2ca3",
			...
			&rabbitmqhandler.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`[{"id":"d3162c64-3507-11ed-afa2-cbb3e904a7b3","customer_id":"00000000-0000-0000-0000-000000000000","chatroom_id":"00000000-0000-0000-0000-000000000000","messagechat_id":"00000000-0000-0000-0000-000000000000","message":{"source":null,"type":"","text":"","medias":null},"tm_create":"","tm_update":"","tm_delete":""}]`),
			},
		},
		{
			"gets by chatroom id return 2 item",
			&rabbitmqhandler.Request{
				URI:      "/v1/messagechatrooms?page_token=2020-10-10T03:30:17.000000&page_size=10&chatroom_id=3b683b7c-3508-11ed-97bb-9be24437edc2",
				Method:   rabbitmqhandler.RequestMethodGet,
				DataType: "application/json",
			},
			...
			&rabbitmqhandler.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`[{"id":"3bacdc46-3508-11ed-8422-1766fe775e1a","customer_id":"00000000-0000-0000-0000-000000000000","chatroom_id":"00000000-0000-0000-0000-000000000000","messagechat_id":"00000000-0000-0000-0000-000000000000","message":{"source":null,"type":"","text":"","medias":null},"tm_create":"","tm_update":"","tm_delete":""},{"id":"3c985216-3508-11ed-b760-5bd81cf30313","customer_id":"00000000-0000-0000-0000-000000000000","chatroom_id":"00000000-0000-0000-0000-000000000000","messagechat_id":"00000000-0000-0000-0000-000000000000","message":{"source":null,"type":"","text":"","medias":null},"tm_create":"","tm_update":"","tm_delete":""}]`),
			},
		},
		{
			"gets by chat id return 0 item",
			&rabbitmqhandler.Request{
				URI:      "/v1/messagechatrooms?page_token=2020-10-10T03:30:17.000000&page_size=10&chatroom_id=4829801e-3503-11ed-aecf-4f1b13ce1b9f",
				Method:   rabbitmqhandler.RequestMethodGet,
				DataType: "application/json",
			},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockMessagechatroom.EXPECT().GetsByChatroomID(gomock.Any(), tt.chatroomID, tt.pageToken, tt.pageSize).Return(tt.responseMessagechatrooms, nil)
	...
	tests := []struct {
	...
	}{
		{
			...
			&rabbitmqhandler.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"92c89948-3508-11ed-9b4f-77544678aa39","customer_id":"00000000-0000-0000-0000-000000000000","chatroom_id":"00000000-0000-0000-0000-000000000000","messagechat_id":"00000000-0000-0000-0000-000000000000","message":{"source":null,"type":"","text":"","medias":null},"tm_create":"","tm_update":"","tm_delete":""}`),
			},
		},
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			&rabbitmqhandler.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"ce2b7f32-3508-11ed-8a20-a32e4374af3f","customer_id":"00000000-0000-0000-0000-000000000000","chatroom_id":"00000000-0000-0000-0000-000000000000","messagechat_id":"00000000-0000-0000-0000-000000000000","message":{"source":null,"type":"","text":"","medias":null},"tm_create":"","tm_update":"","tm_delete":""}`),
			},
		},
	}

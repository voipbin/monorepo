...
type Rabbit interface {
	...
	PublishExchangeDelayedRequest(exchange, key string, req *models.Request, delay int) error
	PublishExchangeRequest(exchange, key string, req *models.Request) error
	PublishEvent(queueName string, evt *models.Event) error
	PublishRequest(queueName string, req *models.Request) error
	PublishRPC(ctx context.Context, queueName string, req *models.Request) (*models.Response, error)
...
type CbMsgConsume func(*models.Event) error

// CbMsgRPC is func prototype for RPC callback
type CbMsgRPC func(*models.Request) (*models.Response, error)

...
func (h *channelHandler) MuteOff(ctx context.Context, id string, direction channel.MuteDirection) error {
	log := logrus.WithFields(logrus.Fields{
		"func":       "MuteOff",
		"channel_id": id,
	})
	...
	if errReq := h.reqHandler.AstChannelMuteOff(ctx, cn.AsteriskID, cn.ID, string(direction)); errReq != nil {

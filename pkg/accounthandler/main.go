...
//go:generate go run -mod=mod github.com/golang/mock/mockgen -package accounthandler -destination ./mock_messagetargethandler.go -source main.go -build_flags=-mod=mod

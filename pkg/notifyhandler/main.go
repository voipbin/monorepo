...
const (
	...
	// queue
	EventTypeQueueCreated EventType = "queue_created"
	EventTypeQueueUpdated EventType = "queue_updated"
	EventTypeQueueDeleted EventType = "queue_deleted"
...
// EventPublisher type
const EventPublisher = "queue-manager"
...
func (r *notifyHandler) publishNotify(eventType string, dataType string, data json.RawMessage, timeout int) error {
	...
	log.Debugf("Publishing the notification. type: %s", eventType)

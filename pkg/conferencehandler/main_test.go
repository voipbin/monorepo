	...
	tests := []test{
		{
			...
			true,
			"conference_type=,conference_id=3a3c10fc-934d-11ea-89ac-9fc52ba9880b,joining=true",
		},
		{
			"Type echo",
			conference.TypeEcho,
			...
			false,
			"conference_type=echo,conference_id=e795ae9e-934c-11ea-90b5-af626e0c8e93,joining=false",
		},
		{
			"Type transfer",
			...
			false,
			"conference_type=transfer,conference_id=721e7aa0-934d-11ea-bb8a-07680a5af6dc,joining=false",
		},
		{
			"Type transfer",
			...
			false,
			"conference_type=conference,conference_id=85d782a8-934d-11ea-afcc-db85d6e1a911,joining=false",
		},
	}

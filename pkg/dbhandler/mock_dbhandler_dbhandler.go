...
func (m *MockDBHandler) FlowCreate(ctx context.Context, flow *flow.Flow) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FlowCreate", ctx, flow)
	ret0, _ := ret[0].(error)
	return ret0
}

// FlowCreate indicates an expected call of FlowCreate.
func (mr *MockDBHandlerMockRecorder) FlowCreate(ctx, flow interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FlowCreate", reflect.TypeOf((*MockDBHandler)(nil).FlowCreate), ctx, flow)
}
...
func (m *MockDBHandler) FlowSetToCache(ctx context.Context, flow *flow.Flow) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FlowSetToCache", ctx, flow)
	ret0, _ := ret[0].(error)
	return ret0
}

// FlowSetToCache indicates an expected call of FlowSetToCache.
func (mr *MockDBHandlerMockRecorder) FlowSetToCache(ctx, flow interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FlowSetToCache", reflect.TypeOf((*MockDBHandler)(nil).FlowSetToCache), ctx, flow)
}

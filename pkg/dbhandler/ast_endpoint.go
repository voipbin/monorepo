...
func (h *handler) astEndpointGetFromRow(row *sql.Rows) (*asterisk.AstEndpoint, error) {
	res := &asterisk.AstEndpoint{}
	if err := row.Scan(
		&res.ID,
		&res.Transport,
		&res.AORs,
...
func (h *handler) AstEndpointGetFromDB(ctx context.Context, id string) (*asterisk.AstEndpoint, error) {
...
func (h *handler) AstEndpointSetToCache(ctx context.Context, ednpoint *asterisk.AstEndpoint) error {
...
func (h *handler) AstEndpointGetFromCache(ctx context.Context, id string) (*asterisk.AstEndpoint, error) {
...
func (h *handler) AstEndpointCreate(ctx context.Context, b *asterisk.AstEndpoint) error {

...
func Test_ConversationV1ConversationsGet(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := reqHandler.ConversationV1ConversationGet(context.Background(), tt.conversationID)
			if err != nil {
...
func Test_ConversationV1ConversationGets(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := reqHandler.ConversationV1ConversationGets(ctx, tt.customerID, tt.pageToken, tt.pageSize)
			if err != nil {

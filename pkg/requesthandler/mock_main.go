...
func (m *MockRequestHandler) CallV1ConfbridgeDelete(ctx context.Context, confbridgeID uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (m *MockRequestHandler) CallV1ConfbridgeRecordingStop(ctx context.Context, callID uuid.UUID) (*confbridge.Confbridge, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CallV1ConfbridgeRecordingStop", ctx, callID)
	ret0, _ := ret[0].(*confbridge.Confbridge)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRequestHandlerMockRecorder) CallV1ConfbridgeRecordingStop(ctx, callID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallV1ConfbridgeRecordingStop", reflect.TypeOf((*MockRequestHandler)(nil).CallV1ConfbridgeRecordingStop), ctx, callID)
}
...
func (m *MockRequestHandler) CallV1GroupcallCreate(ctx context.Context, customerID uuid.UUID, source address.Address, destinations []address.Address, flowID, masterCallID uuid.UUID, ringMethod groupcall.RingMethod, answerMethod groupcall.AnswerMethod, connect bool) (*groupcall.Groupcall, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CallV1GroupcallCreate", ctx, customerID, source, destinations, flowID, masterCallID, ringMethod, answerMethod, connect)
...
func (mr *MockRequestHandlerMockRecorder) CallV1GroupcallCreate(ctx, customerID, source, destinations, flowID, masterCallID, ringMethod, answerMethod, connect interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallV1GroupcallCreate", reflect.TypeOf((*MockRequestHandler)(nil).CallV1GroupcallCreate), ctx, customerID, source, destinations, flowID, masterCallID, ringMethod, answerMethod, connect)
}
...
func (m *MockRequestHandler) CallV1GroupcallHangup(ctx context.Context, callID uuid.UUID) (*groupcall.Groupcall, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CallV1GroupcallHangup", ctx, callID)
	ret0, _ := ret[0].(*groupcall.Groupcall)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRequestHandlerMockRecorder) CallV1GroupcallHangup(ctx, callID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallV1GroupcallHangup", reflect.TypeOf((*MockRequestHandler)(nil).CallV1GroupcallHangup), ctx, callID)
}
...
func (m *MockRequestHandler) ChatbotV1ChatbotCreate(ctx context.Context, customerID uuid.UUID, name, detail string, engineType chatbot.EngineType) (*chatbot.Chatbot, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChatbotV1ChatbotCreate", ctx, customerID, name, detail, engineType)
...
func (mr *MockRequestHandlerMockRecorder) ChatbotV1ChatbotCreate(ctx, customerID, name, detail, engineType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChatbotV1ChatbotCreate", reflect.TypeOf((*MockRequestHandler)(nil).ChatbotV1ChatbotCreate), ctx, customerID, name, detail, engineType)
}
...
func (m *MockRequestHandler) ChatbotV1ServiceTypeChabotcallStart(ctx context.Context, customerID, chatbotID uuid.UUID, referenceType chatbotcall.ReferenceType, referenceID uuid.UUID, gender chatbotcall.Gender, language string) (*service.Service, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChatbotV1ServiceTypeChabotcallStart", ctx, customerID, chatbotID, referenceType, referenceID, gender, language)
...
func (mr *MockRequestHandlerMockRecorder) ChatbotV1ServiceTypeChabotcallStart(ctx, customerID, chatbotID, referenceType, referenceID, gender, language interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChatbotV1ServiceTypeChabotcallStart", reflect.TypeOf((*MockRequestHandler)(nil).ChatbotV1ServiceTypeChabotcallStart), ctx, customerID, chatbotID, referenceType, referenceID, gender, language)
}

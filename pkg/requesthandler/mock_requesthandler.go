...
func (m *MockRequestHandler) CMV1CallCreateWithID(ctx context.Context, id, customerID, flowID, masterCallID uuid.UUID, source, destination *address.Address) (*call.Call, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CMV1CallCreateWithID", ctx, id, customerID, flowID, masterCallID, source, destination)
	ret0, _ := ret[0].(*call.Call)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRequestHandlerMockRecorder) CMV1CallCreateWithID(ctx, id, customerID, flowID, masterCallID, source, destination interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CMV1CallCreateWithID", reflect.TypeOf((*MockRequestHandler)(nil).CMV1CallCreateWithID), ctx, id, customerID, flowID, masterCallID, source, destination)
}
...
func (m *MockRequestHandler) FMV1ActiveflowCreate(ctx context.Context, flowID uuid.UUID, referenceType activeflow.ReferenceType, referenceID uuid.UUID) (*activeflow.Activeflow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FMV1ActiveflowCreate", ctx, flowID, referenceType, referenceID)
...
func (mr *MockRequestHandlerMockRecorder) FMV1ActiveflowCreate(ctx, flowID, referenceType, referenceID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FMV1ActiveflowCreate", reflect.TypeOf((*MockRequestHandler)(nil).FMV1ActiveflowCreate), ctx, flowID, referenceType, referenceID)
}

...
//go:generate go run -mod=mod github.com/golang/mock/mockgen -package confbridgehandler -destination ./mock_confbridgehandler.go -source main.go -build_flags=-mod=mod

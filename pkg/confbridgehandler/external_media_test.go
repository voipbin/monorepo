...
func Test_ExternalMediaStart(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockExternal.EXPECT().Start(ctx, externalmedia.ReferenceTypeConfbridge, tt.id, tt.externalHost, tt.encapsulation, tt.transport, tt.connectionType, tt.format, tt.direction).Return(tt.responseExternalMedia, nil)

...
func (e AIManagerToolName) Valid() bool {
	...
	case AIManagerToolNameGetAicallMessages:
		return true
	case AIManagerToolNameGetCallTranscript:
		return true
...
type ApiManagerExtensionProvisioningToken struct {
	// Expire Timestamp when the provisioning token expires (10 minutes after issuance).
	//
	// Example: 2026-08-24T12:10:00.000000Z
	Expire *string `json:"expire,omitempty"`

	// Token 64-character lowercase hexadecimal provisioning token. Generated by api-manager when an authorized agent requests extension provisioning via `POST /extensions/{id}/provisioning-token`.
	//
...
type GetProvisioningExtensionParams struct {
	// Token 64-character lowercase hexadecimal provisioning token. Returned from the `POST /extensions/{id}/provisioning-token` response.
	Token string `form:"token" json:"token"`
}
...
type PostServiceAgentsTranscribesJSONBody struct {
	...
	//
	// Example: 3b7e6f2c-9693-11ed-a72c-8fa9ccd046a7
	Id *openapi_types.UUID `json:"id,omitempty"`

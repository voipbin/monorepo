...
// Source: pkg/providerhandler/main.go
//
// Generated by this command:
//
//	mockgen -package providerhandler -destination ./pkg/providerhandler/mock_main.go -source pkg/providerhandler/main.go -build_flags=-mod=mod
//
...
func (mr *MockProviderHandlerMockRecorder) Delete(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProviderHandlerMockRecorder) Get(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
func (mr *MockRouteHandlerMockRecorder) Delete(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRouteHandlerMockRecorder) DialrouteGets(ctx, customerID, target interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRouteHandlerMockRecorder) Get(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRouteHandlerMockRecorder) GetsByCustomerID(ctx, customerID, token, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRouteHandlerMockRecorder) GetsByTarget(ctx, customerID, target interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

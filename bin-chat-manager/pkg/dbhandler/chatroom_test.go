...
func Test_ChatroomCreate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res.TMUpdate = ""
			res.TMDelete = ""
			tt.expectRes.TMCreate = ""
			tt.expectRes.TMUpdate = ""
			tt.expectRes.TMDelete = ""
...
func Test_ChatroomList(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			map[chatroom.Field]any{
				chatroom.FieldCustomerID:  uuid.FromStringOrNil("63331078-4431-43ed-96ac-5975fa9e6749"),
				chatroom.FieldDeleted:     false,
				chatroom.FieldType:        chatroom.TypeNormal,
				chatroom.FieldRoomOwnerID: uuid.FromStringOrNil("155d19da-bac6-11ee-8ed8-8fff6c8907d5"),
				chatroom.FieldChatID:      uuid.FromStringOrNil("152d7e64-bac6-11ee-a61f-67fba233c588"),
			},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			cs, err := h.ChatroomList(ctx, utilhandler.TimeGetCurTime(), tt.size, tt.filters)
			if err != nil {
				t.Errorf("Wrong match. expect: ok, got: %v", err)
			}

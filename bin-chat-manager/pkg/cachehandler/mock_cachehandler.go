...
func (mr *MockCacheHandlerMockRecorder) ChatGet(ctx, id interface{}) *gomock.Call {
...
func (mr *MockCacheHandlerMockRecorder) ChatSet(ctx, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) ChatroomGet(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) ChatroomSet(ctx, af interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) MessagechatGet(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) MessagechatSet(ctx, t interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) MessagechatroomGet(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) MessagechatroomSet(ctx, t interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

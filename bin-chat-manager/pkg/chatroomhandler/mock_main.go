...
//
//	mockgen -package chatroomhandler -destination ./mock_main.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockChatroomHandlerMockRecorder) AddParticipantID(ctx, id, participantID any) *gomock.Call {
...
func (mr *MockChatroomHandlerMockRecorder) Create(ctx, customerID, agentID, chatroomType, chatID, ownerID, participantIDs, name, detail any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatroomHandlerMockRecorder) Delete(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatroomHandlerMockRecorder) Get(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatroomHandlerMockRecorder) RemoveParticipantID(ctx, id, participantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatroomHandlerMockRecorder) UpdateBasicInfo(ctx, id, name, detail any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
func (h *streamingHandler) StartTCP(ctx context.Context, customerID uuid.UUID, transcribeID uuid.UUID, referenceType transcribe.ReferenceType, referenceID uuid.UUID, language string, direction transcript.Direction) (*streaming.Streaming, error) {
	...
	res, err := h.Create(ctx, customerID, transcribeID, uuid.Nil, language, direction)
	if err != nil {
...
// StartUDP starts the live streaming transcribe of the given transcribe
func (h *streamingHandler) StartUDP(ctx context.Context, customerID uuid.UUID, transcribeID uuid.UUID, referenceType transcribe.ReferenceType, referenceID uuid.UUID, language string, direction transcript.Direction) (*streaming.Streaming, error) {

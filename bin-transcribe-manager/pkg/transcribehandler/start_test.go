...
// 				mockStreaming.EXPECT().StartUDP(ctx, tt.customerID, tt.responseUUID, tt.referenceType, tt.referenceID, tt.language, transcript.DirectionIn).Return(tt.responseStreamings[0], nil)
// 				mockStreaming.EXPECT().StartUDP(ctx, tt.customerID, tt.responseUUID, tt.referenceType, tt.referenceID, tt.language, transcript.DirectionOut).Return(tt.responseStreamings[1], nil)
// 			} else {
// 				mockStreaming.EXPECT().StartUDP(ctx, tt.customerID, tt.responseUUID, tt.referenceType, tt.referenceID, tt.language, tt.direction).Return(tt.responseStreamings[0], nil)
// 			}

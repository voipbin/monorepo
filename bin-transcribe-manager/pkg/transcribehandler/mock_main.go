...
//
//	mockgen -package transcribehandler -destination ./mock_main.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockTranscribeHandlerMockRecorder) Delete(ctx, id any) *gomock.Call {
...
func (mr *MockTranscribeHandlerMockRecorder) EventCMCallHangup(ctx, c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTranscribeHandlerMockRecorder) EventCMConfbridgeTerminated(ctx, c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTranscribeHandlerMockRecorder) EventCUCustomerDeleted(ctx, cu any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTranscribeHandlerMockRecorder) Get(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTranscribeHandlerMockRecorder) GetByReferenceIDAndLanguage(ctx, referenceID, language any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockTranscribeHandler) Start(ctx context.Context, customerID, activeflowID, onEndFlowID uuid.UUID, referenceType transcribe.ReferenceType, referenceID uuid.UUID, language string, direction transcribe.Direction) (*transcribe.Transcribe, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Start", ctx, customerID, activeflowID, onEndFlowID, referenceType, referenceID, language, direction)
	ret0, _ := ret[0].(*transcribe.Transcribe)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTranscribeHandlerMockRecorder) Start(ctx, customerID, activeflowID, onEndFlowID, referenceType, referenceID, language, direction any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockTranscribeHandler)(nil).Start), ctx, customerID, activeflowID, onEndFlowID, referenceType, referenceID, language, direction)
}
...
func (mr *MockTranscribeHandlerMockRecorder) Stop(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

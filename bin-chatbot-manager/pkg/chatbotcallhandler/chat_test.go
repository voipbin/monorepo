...
// 			res, err := h.chatMessageReferenceTypeCall(ctx, tt.chatbotcall, tt.message.Content)
// 			if err != nil {
// 				t.Errorf("Wrong match. expect: ok, got: %v", err)
// 			}
...
// 			res, err := h.chatMessageReferenceTypeNone(ctx, tt.chatbotcall, tt.message.Content)
// 			if err != nil {
// 				t.Errorf("Wrong match. expect: ok, got: %v", err)
// 			}

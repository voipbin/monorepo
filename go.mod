...
require (
	...
	gitlab.com/voipbin/bin-manager/call-manager.git v0.0.0-20220524154730-deb23115c450
	...
	gitlab.com/voipbin/bin-manager/webhook-manager.git v0.0.0-20220523054649-bd614f2bc35a
)

...
require (
	...
	gitlab.com/voipbin/bin-manager/flow-manager.git v0.0.0-20220625170238-2cdbf69a58c9
...
require (
	...
	gitlab.com/voipbin/bin-manager/tts-manager.git v0.0.0-20220627060255-4fcb74b10bde // indirect

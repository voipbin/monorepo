...
require (
	...
	gitlab.com/voipbin/bin-manager/flow-manager.git v0.0.0-20220412175812-e3d227695351
)
...
require (
	...
	gitlab.com/voipbin/bin-manager/storage-manager.git v0.0.0-20220413020524-2f0926b5d42d // indirect

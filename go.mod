module gitlab.com/voipbin/bin-manager/tts-manager.git
...
require (
	...
	gitlab.com/voipbin/bin-manager/common-handler.git v0.0.0-20230709115540-503f39faf1ce
...
require (
	...
	gitlab.com/voipbin/bin-manager/agent-manager.git v0.0.0-20230306012236-f2470b06b6ca // indirect
	gitlab.com/voipbin/bin-manager/billing-manager.git v0.0.0-20230704172755-d15a213de4e3 // indirect
	gitlab.com/voipbin/bin-manager/call-manager.git v0.0.0-20230715054707-95635b20f077 // indirect
	...
	gitlab.com/voipbin/bin-manager/chatbot-manager.git v0.0.0-20230526095512-b24c67e40013 // indirect
	...
	gitlab.com/voipbin/bin-manager/number-manager.git v0.0.0-20230712161740-5a6ad6f99ba8 // indirect

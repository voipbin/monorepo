...
require (
	...
	gitlab.com/voipbin/bin-manager/common-handler.git v0.0.0-20220426051033-09cfcac3dd6f
...
require (
	...
	gitlab.com/voipbin/bin-manager/outdial-manager.git v0.0.0-20220426045258-191ea1ab94ed // indirect

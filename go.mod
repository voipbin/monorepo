...
require (
	...
	gitlab.com/voipbin/bin-manager/hook-manager.git v0.0.0-20220910161114-850aece1ef56
	...
	gitlab.com/voipbin/bin-manager/route-manager.git v0.0.0-20221012132117-4b73a60cc9cc

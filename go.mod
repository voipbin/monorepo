...
require (
	...
	gitlab.com/voipbin/bin-manager/call-manager.git v0.0.0-20230107191306-fdf7f6785078
	...
	gitlab.com/voipbin/bin-manager/storage-manager.git v0.0.0-20230107173254-4e277ec80cc0

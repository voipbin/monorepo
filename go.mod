...
require (
	...
	gitlab.com/voipbin/bin-manager/billing-manager.git v0.0.0-20230615163000-b4dc69ec0719 // indirect
	...
	gitlab.com/voipbin/bin-manager/customer-manager.git v0.0.0-20230604162846-9d4a40ced4cb // indirect

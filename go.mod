...
require (
	...
	gitlab.com/voipbin/bin-manager/hook-manager.git v0.0.0-20240213144049-cc83b995da3f
	...
	gitlab.com/voipbin/bin-manager/registrar-manager.git v0.0.0-20240217163436-88fe695818c4

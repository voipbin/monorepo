...
require (
	...
	gitlab.com/voipbin/bin-manager/common-handler.git v0.0.0-20230107175706-2937a92cf4dc
...
require (
	...
	gitlab.com/voipbin/bin-manager/storage-manager.git v0.0.0-20230107173254-4e277ec80cc0 // indirect

...
require (
	...
	gitlab.com/voipbin/bin-manager/campaign-manager.git v0.0.0-20220611221159-105a58a847e8
	...
	gitlab.com/voipbin/bin-manager/message-manager.git v0.0.0-20220610055118-53363f20ab10

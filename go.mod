...
require (
	...
	gitlab.com/voipbin/bin-manager/request-manager.git v0.0.0-20211201020144-88841dfe4932
...
require (
	...
	gitlab.com/voipbin/bin-manager/conference-manager.git v0.0.0-20211117045559-85c8d74244e2 // indirect

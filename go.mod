...
require (
	...
	gitlab.com/voipbin/bin-manager/call-manager.git v0.0.0-20221002131835-61a97986243b
...
require (
	...
	gitlab.com/voipbin/bin-manager/route-manager.git v0.0.0-20221017023935-4d666b5977f3

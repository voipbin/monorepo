...
require (
	...
	gitlab.com/voipbin/bin-manager/hook-manager.git v0.0.0-20231130225603-8939d436e934
	...
	gitlab.com/voipbin/bin-manager/queue-manager.git v0.0.0-20240112140116-0943ccc8fb85

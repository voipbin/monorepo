...
require (
	...
	gitlab.com/voipbin/bin-manager/common-handler.git v0.0.0-20230119064739-08d257ecd571
...
require (
	...
	gitlab.com/voipbin/bin-manager/transcribe-manager.git v0.0.0-20230117184019-436f4bd36e90 // indirect

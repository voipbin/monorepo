...
require (
	...
	gitlab.com/voipbin/bin-manager/common-handler.git v0.0.0-20230910161346-cd740bb702f5
...
require (
	...
	gitlab.com/voipbin/bin-manager/registrar-manager.git v0.0.0-20230910155832-c00e3dd0cc86 // indirect

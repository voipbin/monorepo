...
require (
	...
	gitlab.com/voipbin/bin-manager/common-handler.git v0.0.0-20230224055756-edc1ed414a7d
...
require (
	...
	gitlab.com/voipbin/bin-manager/registrar-manager.git v0.0.0-20230224053508-d89a7fe38851 // indirect

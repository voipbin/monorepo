...
// Source: pkg/servicehandler/main.go
//
// Generated by this command:
//
//	mockgen -package servicehandler -destination ./pkg/servicehandler/mock_main.go -source pkg/servicehandler/main.go -build_flags=-mod=mod
//
...
// CustomerEmailVerifyResend mocks base method.
func (m *MockServiceHandler) CustomerEmailVerifyResend(ctx context.Context, arg1 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CustomerEmailVerifyResend", ctx, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// CustomerEmailVerifyResend indicates an expected call of CustomerEmailVerifyResend.
func (mr *MockServiceHandlerMockRecorder) CustomerEmailVerifyResend(ctx, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CustomerEmailVerifyResend", reflect.TypeOf((*MockServiceHandler)(nil).CustomerEmailVerifyResend), ctx, arg1)
}
...
func (m *MockServiceHandler) InteractionList(ctx context.Context, a *auth.AuthIdentity, size uint64, token, peerType, peerTarget string, contactID, addressID uuid.UUID) ([]*peerevent.PeerEvent, string, error) {
	m.ctrl.T.Helper()
...
// ServiceAgentAIcallListen mocks base method.
func (m *MockServiceHandler) ServiceAgentAIcallListen(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID) (*aicall.WebhookMessage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ServiceAgentAIcallListen", ctx, a, id)
	ret0, _ := ret[0].(*aicall.WebhookMessage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ServiceAgentAIcallListen indicates an expected call of ServiceAgentAIcallListen.
func (mr *MockServiceHandlerMockRecorder) ServiceAgentAIcallListen(ctx, a, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ServiceAgentAIcallListen", reflect.TypeOf((*MockServiceHandler)(nil).ServiceAgentAIcallListen), ctx, a, id)
}

...
func (m *MockServiceHandler) AICreate(ctx context.Context, a *agent.Agent, name, detail string, engineModel ai.EngineModel, parameter map[string]any, engineKey string, ragID uuid.UUID, initPrompt string, ttsType ai.TTSType, ttsVoiceID string, sttType ai.STTType, toolNames []tool.ToolName) (*ai.WebhookMessage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AICreate", ctx, a, name, detail, engineModel, parameter, engineKey, ragID, initPrompt, ttsType, ttsVoiceID, sttType, toolNames)
...
func (mr *MockServiceHandlerMockRecorder) AICreate(ctx, a, name, detail, engineModel, parameter, engineKey, ragID, initPrompt, ttsType, ttsVoiceID, sttType, toolNames any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AICreate", reflect.TypeOf((*MockServiceHandler)(nil).AICreate), ctx, a, name, detail, engineModel, parameter, engineKey, ragID, initPrompt, ttsType, ttsVoiceID, sttType, toolNames)
}
...
func (m *MockServiceHandler) AIUpdate(ctx context.Context, a *agent.Agent, id uuid.UUID, name, detail string, engineModel ai.EngineModel, parameter map[string]any, engineKey string, ragID uuid.UUID, initPrompt string, ttsType ai.TTSType, ttsVoiceID string, sttType ai.STTType, toolNames []tool.ToolName) (*ai.WebhookMessage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AIUpdate", ctx, a, id, name, detail, engineModel, parameter, engineKey, ragID, initPrompt, ttsType, ttsVoiceID, sttType, toolNames)
	ret0, _ := ret[0].(*ai.WebhookMessage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceHandlerMockRecorder) AIUpdate(ctx, a, id, name, detail, engineModel, parameter, engineKey, ragID, initPrompt, ttsType, ttsVoiceID, sttType, toolNames any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AIUpdate", reflect.TypeOf((*MockServiceHandler)(nil).AIUpdate), ctx, a, id, name, detail, engineModel, parameter, engineKey, ragID, initPrompt, ttsType, ttsVoiceID, sttType, toolNames)
}

// AIcallCreate mocks base method.
func (m *MockServiceHandler) AIcallCreate(ctx context.Context, a *agent.Agent, assistanceType aicall.AssistanceType, assistanceID uuid.UUID, referenceType aicall.ReferenceType, referenceID uuid.UUID, gender aicall.Gender, language string) (*aicall.WebhookMessage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AIcallCreate", ctx, a, assistanceType, assistanceID, referenceType, referenceID, gender, language)
...
func (mr *MockServiceHandlerMockRecorder) AIcallCreate(ctx, a, assistanceType, assistanceID, referenceType, referenceID, gender, language any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AIcallCreate", reflect.TypeOf((*MockServiceHandler)(nil).AIcallCreate), ctx, a, assistanceType, assistanceID, referenceType, referenceID, gender, language)
}
...
func (m *MockServiceHandler) CustomerSelfUpdateMetadata(ctx context.Context, a *agent.Agent, metadata customer.Metadata) (*customer.WebhookMessage, error) {
	m.ctrl.T.Helper()
...
func (m *MockServiceHandler) TranscribeStart(ctx context.Context, a *agent.Agent, referenceType string, referenceID uuid.UUID, language string, direction transcribe.Direction, onEndFlowID uuid.UUID, provider transcribe.Provider) (*transcribe.WebhookMessage, error) {
	m.ctrl.T.Helper()

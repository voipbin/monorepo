...
type ServiceHandler interface {
	...
	// speaking handlers
	SpeakingCreate(ctx context.Context, a *amagent.Agent, referenceType string, referenceID uuid.UUID, language string, provider string, voiceID string, direction string) (*tmspeaking.Speaking, error)

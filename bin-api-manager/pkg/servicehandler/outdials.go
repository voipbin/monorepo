...
func (h *serviceHandler) OutdialCreate(ctx context.Context, a *auth.AuthIdentity, campaignID uuid.UUID, name, detail, data string) (*omoutdial.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
		"func":        "OutdialCreate",
...
func (h *serviceHandler) OutdialGetsByCustomerID(ctx context.Context, a *auth.AuthIdentity, size uint64, token string) ([]*omoutdial.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
...
func (h *serviceHandler) OutdialDelete(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID) (*omoutdial.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
		"func":        "OutdialDelete",
		"customer_id": a.CustomerID,
		"username":    a.DisplayName(),
...
func (h *serviceHandler) OutdialGet(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID) (*omoutdial.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
		"func":        "OutdialGet",
		"customer_id": a.CustomerID,
		"username":    a.DisplayName(),
...
func (h *serviceHandler) OutdialUpdateBasicInfo(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID, name, detail string) (*omoutdial.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
...
// It returns updated outdial if it succeed.
func (h *serviceHandler) OutdialUpdateCampaignID(ctx context.Context, a *auth.AuthIdentity, id, campaignID uuid.UUID) (*omoutdial.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
...
// It returns updated outdial if it succeed.
func (h *serviceHandler) OutdialUpdateData(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID, data string) (*omoutdial.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{

...
func (h *serviceHandler) CampaignGetsByCustomerID(ctx context.Context, a *auth.AuthIdentity, size uint64, token string) ([]*cacampaign.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
...
func (h *serviceHandler) CampaignGet(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID) (*cacampaign.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
		"func":        "CampaignGet",
		"customer_id": a.CustomerID,
		"username":    a.DisplayName(),
...
func (h *serviceHandler) CampaignDelete(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID) (*cacampaign.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
		"func":        "CampaignDelete",
		"customer_id": a.CustomerID,
		"username":    a.DisplayName(),
...
// It returns updated campaign if it succeed.
func (h *serviceHandler) CampaignUpdateStatus(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID, status cacampaign.Status) (*cacampaign.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
...
// It returns updated campaign if it succeed.
func (h *serviceHandler) CampaignUpdateServiceLevel(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID, serviceLevel int) (*cacampaign.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
...
// It returns updated campaign if it succeed.
func (h *serviceHandler) CampaignUpdateActions(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID, actions []fmaction.Action) (*cacampaign.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
...
// It returns updated campaign if it succeed.
func (h *serviceHandler) CampaignUpdateResourceInfo(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID, outplanID uuid.UUID, outdialID uuid.UUID, queueID uuid.UUID, nextCampaignID uuid.UUID) (*cacampaign.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{
...
// It returns updated campaign if it succeed.
func (h *serviceHandler) CampaignUpdateNextCampaignID(ctx context.Context, a *auth.AuthIdentity, id uuid.UUID, nextCampaignID uuid.UUID) (*cacampaign.WebhookMessage, error) {
	log := logrus.WithFields(logrus.Fields{

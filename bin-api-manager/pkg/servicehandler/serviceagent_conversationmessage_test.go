...
func Test_ServiceAgentConversationMessageGets(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockReq.EXPECT().ConversationV1ConversationMessageGetsByConversationID(ctx, tt.conversationID, tt.token, tt.size).Return(tt.responseConversationMessages, nil)

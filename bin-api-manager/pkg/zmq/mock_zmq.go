...
//
//	mockgen -package zmq -destination ./mock_zmq.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockZMQMockRecorder) Bind(t, addr any) *gomock.Call {
...
func (mr *MockZMQMockRecorder) Connect(t, addr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockZMQMockRecorder) Publish(topic, m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockZMQMockRecorder) Subscribe(topic any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockZMQMockRecorder) Unsubscribe(topic any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

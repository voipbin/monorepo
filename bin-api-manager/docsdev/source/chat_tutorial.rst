...
.. code::
    ...
    $ curl --location --request GET 'https://api.voipbin.net/v1.0/chats?token=<YOUR_AUTH_TOKEN>'
...
.. code::
    ...
    $ curl --location --request GET 'https://api.voipbin.net/v1.0/chats/e8b2e976-f043-44c8-bb89-e214e225e813?token=<YOUR_AUTH_TOKEN>'
...
.. code::
    ...
    $ curl --location --request POST 'https://api.voipbin.net/v1.0/chats?token=<YOUR_AUTH_TOKEN>' \
...
.. code::
    ...
    $ curl --location --request GET 'https://api.voipbin.net/v1.0/chatrooms?token=<YOUR_AUTH_TOKEN>&owner_id=eb1ac5c0-ff63-47e2-bcdb-5da9c336eb4b'
...
.. code::
    ...
    $ curl --location --request POST 'https://api.voipbin.net/v1.0/chatmessages?token=<YOUR_AUTH_TOKEN>' \
        --header 'Content-Type: text/plain' \
        --data-raw '{
            "chat_id": "e8b2e976-f043-44c8-bb89-e214e225e813",
            "source": {

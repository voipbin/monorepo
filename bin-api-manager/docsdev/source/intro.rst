...
.. note:: **AI Context**
   ...
   This page provides a high-level overview of VoIPBIN's capabilities. For implementation details, see the individual resource pages (Calls, Flows, AI, etc.) linked in the table of contents.

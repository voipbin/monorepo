	...
	tests := []test{
		{
			...
			reqQuery: "/queues",
			reqBody:  []byte(`{"name":"test name","detail":"test detail","routing_method":"random","tag_ids":["296b096c-6476-11ec-8fc0-2f39371fef93"],"wait_flow_id":"74341d62-2115-11f0-b44e-871d5b4ad40e","wait_timeout":10000,"service_timeout":100000}`),
	...
	tests := []test{
		{
			...
			reqBody:  []byte(`{"name":"new name","detail":"new detail","routing_method":"random","tag_ids":["7e1be274-4a89-11ee-84ec-5b122e282794","7e762acc-4a89-11ee-9c08-43e00aea3bd6"],"wait_flow_id":"c02a144c-2115-11f0-a9d5-97e0c247bb7b","wait_timeout":60000,"service_timeout":6000000}`),

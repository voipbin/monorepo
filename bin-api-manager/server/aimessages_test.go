...
func Test_PostAimessages(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedRes: `{"id":"dbceb866-4506-4e86-9851-a82d4d3ced88","customer_id":"00000000-0000-0000-0000-000000000000","aicall_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","role":"","content":"","direction":"","tm_create":null}`,
		},
	}
	...
	tests := []test{
		{
			...
			expectedRes:       `{"result":[{"id":"ed2346dc-f31e-11ef-acd5-67a8f966fe17","customer_id":"00000000-0000-0000-0000-000000000000","aicall_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","role":"","content":"","direction":"","tm_create":"2020-09-20T03:23:21.995Z"}],"next_page_token":"2020-09-20T03:23:21.995000Z"}`,
		},
		{
			...
			expectedPageSize:  10,
			expectedPageToken: "2020-09-20T03:23:20.995000Z",
			expectedRes:       `{"result":[{"id":"1707f380-f31f-11ef-bfe4-7ff769b357b3","customer_id":"00000000-0000-0000-0000-000000000000","aicall_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","role":"","content":"","direction":"","tm_create":"2020-09-20T03:23:21.995Z"},{"id":"17268426-f31f-11ef-aa11-6f21c1723af6","customer_id":"00000000-0000-0000-0000-000000000000","aicall_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","role":"","content":"","direction":"","tm_create":"2020-09-20T03:23:22.995Z"},{"id":"17468500-f31f-11ef-b7b6-9b29397f4894","customer_id":"00000000-0000-0000-0000-000000000000","aicall_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","role":"","content":"","direction":"","tm_create":"2020-09-20T03:23:23.995Z"}],"next_page_token":"2020-09-20T03:23:23.995000Z"}`,
		},
	}
...
func Test_GetAimessagesId(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectRes:           `{"id":"796924c2-f31f-11ef-8589-c3efd79e11d5","customer_id":"00000000-0000-0000-0000-000000000000","aicall_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","role":"","content":"","direction":"","tm_create":null}`,
		},
	}
...
func Test_DeleteAimessagesId(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedRes:         `{"id":"ab6f6c84-b9c2-4350-9978-4336b677603c","customer_id":"00000000-0000-0000-0000-000000000000","aicall_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","role":"","content":"","direction":"","tm_create":null}`,
		},
	}
...
// Test_aimessagesPost_InsufficientBalance exercises the servicehandler-failure
...
func Test_aimessagesPost_InsufficientBalance(t *testing.T) {
	...
	body := []byte(`{"aicall_id":"e7b9d44a-c514-11ef-9ec3-87dfeb9a6d3e","role":"user","content":"hello"}`)
	req, _ := http.NewRequest(http.MethodPost, "/aimessages", bytes.NewBuffer(body))
	req.Header.Set("Content-Type", "application/json")
	// The RequestID middleware augments the context, so match with gomock.Any().
	mockSvc.EXPECT().
		AImessageCreate(gomock.Any(), agent, gomock.Any(), gomock.Any(), gomock.Any()).

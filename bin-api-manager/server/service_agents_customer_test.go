	...
	tests := []test{
		{
			...
			expectedRes: []byte(`{"id":"9aae8ff0-bc88-11ef-8111-0fd82660b367","billing_account_id":"00000000-0000-0000-0000-000000000000","metadata":{"rtp_debug":false},"email_verified":false,"status":"","tm_deletion_scheduled":null,"tm_create":null,"tm_update":null,"tm_delete":null}`),
		},
	}

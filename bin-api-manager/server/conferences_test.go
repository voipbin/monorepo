...
func Test_conferencesPOST(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedRes:        `{"id":"ee1e90cc-ac7a-11ea-8474-e740530b4266","customer_id":"00000000-0000-0000-0000-000000000000","pre_flow_id":"00000000-0000-0000-0000-000000000000","post_flow_id":"00000000-0000-0000-0000-000000000000","recording_id":"00000000-0000-0000-0000-000000000000","transcribe_id":"00000000-0000-0000-0000-000000000000","direct_hash":"","tm_end":null,"tm_create":null,"tm_update":null,"tm_delete":null}`,
		},
		{
			name: "empty data",
			agent: auth.NewAgentIdentity(&amagent.Agent{
			...
			expectedRes:        `{"id":"62fc88ba-3fe9-11ec-8ebb-8f1ee591edec","customer_id":"00000000-0000-0000-0000-000000000000","pre_flow_id":"00000000-0000-0000-0000-000000000000","post_flow_id":"00000000-0000-0000-0000-000000000000","recording_id":"00000000-0000-0000-0000-000000000000","transcribe_id":"00000000-0000-0000-0000-000000000000","direct_hash":"","tm_end":null,"tm_create":null,"tm_update":null,"tm_delete":null}`,
		},
	}
...
// Test_conferencesPost_MissingAuthIdentity verifies PostConferences emits the
// canonical UNAUTHENTICATED / AUTHENTICATION_REQUIRED envelope when
// auth_identity is missing from the gin context.
func Test_conferencesPost_MissingAuthIdentity(t *testing.T) {
	assertMissingAuthIdentity(t, http.MethodPost, "/conferences",
		[]byte(`{"type":"conference","name":"n","detail":"d","data":{},"timeout":0,"pre_flow_id":"00000000-0000-0000-0000-000000000000","post_flow_id":"00000000-0000-0000-0000-000000000000"}`))
}

// Test_conferencesPost_InvalidJSONBody verifies PostConferences rejects
// malformed JSON with INVALID_ARGUMENT / INVALID_JSON_BODY.
func Test_conferencesPost_InvalidJSONBody(t *testing.T) {
	...
	req, _ := http.NewRequest(http.MethodPost, "/conferences", bytes.NewBufferString("{not json"))
	req.Header.Set("Content-Type", "application/json")
	r.ServeHTTP(w, req)
...
// malformed UUID in the path with INVALID_ARGUMENT / INVALID_ID before
// the servicehandler is consulted.
func Test_conferencesIDPut_InvalidID(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	req, _ := http.NewRequest(http.MethodPut, "/conferences/not-a-uuid", bytes.NewBufferString(`{}`))
	req.Header.Set("Content-Type", "application/json")
	r.ServeHTTP(w, req)
...
// PostConferencesIdRecordingStart rejects a malformed UUID in the path
// with INVALID_ARGUMENT / INVALID_ID before the servicehandler is
// consulted.
func Test_conferencesIDRecordingStartPost_InvalidID(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	req, _ := http.NewRequest(http.MethodPost, "/conferences/not-a-uuid/recording_start", bytes.NewBufferString(`{}`))
	req.Header.Set("Content-Type", "application/json")
	r.ServeHTTP(w, req)

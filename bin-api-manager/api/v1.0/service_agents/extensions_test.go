...
func Test_extensionsGET(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			reqQuery: "/v1.0/service_agents/extensions",
			...
			expectRes: `{"result":[{"id":"7ea872bc-bbc5-11ef-83ae-dfcd9b190c58","customer_id":"00000000-0000-0000-0000-000000000000","name":"","detail":"","extension":"","domain_name":"","username":"","password":"","tm_create":"","tm_update":"","tm_delete":""},{"id":"7efedf4e-bbc5-11ef-8d7d-ff69121f9899","customer_id":"00000000-0000-0000-0000-000000000000","name":"","detail":"","extension":"","domain_name":"","username":"","password":"","tm_create":"","tm_update":"","tm_delete":""}],"next_page_token":""}`,
		},
	}
...
func Test_extensionsIDGET(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			reqQuery: "/v1.0/service_agents/extensions/7f22ea24-bbc5-11ef-8c3f-139aa5535776",
			responseExtension: &rmextension.WebhookMessage{
			...
			expectedRes:         `{"id":"7f22ea24-bbc5-11ef-8c3f-139aa5535776","customer_id":"00000000-0000-0000-0000-000000000000","name":"","detail":"","extension":"","domain_name":"","username":"","password":"","tm_create":"","tm_update":"","tm_delete":""}`,
		},
	}

...
type Account struct {
	...
	// TmCreate Timestamp when the account was created. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmCreate *string `json:"tm_create,omitempty"`

	// TmDelete Timestamp when the account was deleted. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmDelete *string `json:"tm_delete,omitempty"`

	// TmUpdate Timestamp when the account was last updated. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
...
type File struct {
	...
	// TmCreate Timestamp when the file was created. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmCreate *string `json:"tm_create,omitempty"`

	// TmDelete Timestamp when the file was deleted. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmDelete *string `json:"tm_delete,omitempty"`

	// TmDownloadExpire The timestamp when the download link expires. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmDownloadExpire *string `json:"tm_download_expire,omitempty"`

	// TmUpdate Timestamp when the file was last updated. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmUpdate *string `json:"tm_update,omitempty"`

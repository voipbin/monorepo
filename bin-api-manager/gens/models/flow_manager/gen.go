...
type Activeflow struct {
	...
	// TmCreate Timestamp when the flow was created. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmCreate *string `json:"tm_create"`

	// TmDelete Timestamp when the flow was deleted. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmDelete *string `json:"tm_delete"`

	// TmUpdate Timestamp when the flow was last updated. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)

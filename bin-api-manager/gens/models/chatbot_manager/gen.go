...
type Chatbot struct {
	...
	// TmCreate Timestamp when the chatbot was created. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmCreate *string `json:"tm_create,omitempty"`

	// TmDelete Timestamp when the chatbot was deleted. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmDelete *string `json:"tm_delete,omitempty"`

	// TmUpdate Timestamp when the chatbot was last updated. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
...
type Chatbotcall struct {
	...
	// TmCreate Timestamp when the chatbot call was created. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmCreate *string `json:"tm_create,omitempty"`

	// TmDelete Timestamp when the chatbot call was deleted. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmDelete *string `json:"tm_delete,omitempty"`

	// TmEnd Timestamp when the chatbot call ended. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmEnd *string `json:"tm_end,omitempty"`

	// TmUpdate Timestamp when the chatbot call was last updated. Custom date-time format(YYYY-MM-DD HH:mm:ss.ssssss)
	TmUpdate *string `json:"tm_update,omitempty"`

...
// Test_topicPatterns_golden pins the EXACT bind set of direct-manager on the global topic
...
func Test_topicPatterns_golden(t *testing.T) {
	...
	// design §5: direct-manager binds exactly 1 pattern.
...
// Test_fanoutUnbindTargets_golden pins the fanout exchanges direct-manager unbinds after a

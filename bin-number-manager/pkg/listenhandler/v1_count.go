...
// processV1NumbersCountVirtualByCustomerGet handles GET /v1/numbers/count_virtual_by_customer
func (h *listenHandler) processV1NumbersCountVirtualByCustomerGet(ctx context.Context, m *sock.Request) (*sock.Response, error) {
	log := logrus.WithFields(logrus.Fields{
		"func":    "processV1NumbersCountVirtualByCustomerGet",
		"request": m,
	})

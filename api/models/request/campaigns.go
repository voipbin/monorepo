...
// BodyCampaignsPOST is rquest body define for POST /campaigns
...
// ParamCampaignsGET is rquest param define for GET /campaigns
type ParamCampaignsGET struct {
	Pagination
}

// BodyCampaignsIDPUT is rquest body define for PUT /campaigns/{id}
type BodyCampaignsIDPUT struct {
	Name   string `json:"name"`
	Detail string `json:"detail"`
}

// BodyCampaignsIDStatusPUT is rquest body define for PUT /campaigns/{id}/status
type BodyCampaignsIDStatusPUT struct {
	Status cacampaign.Status `json:"status"`
}

// BodyCampaignsIDServiceLevelPUT is rquest body define for PUT /campaigns/{id}/service_level
type BodyCampaignsIDServiceLevelPUT struct {
	ServiceLevel int `json:"service_level"`
}

// BodyCampaignsIDActionsPUT is rquest body define for PUT /campaigns/{id}/actions

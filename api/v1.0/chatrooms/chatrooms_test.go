	...
	tests := []test{
		{
			...
			`{"result":[{"id":"f4037f8e-38a0-11ed-8424-5f0d424074aa","customer_id":"00000000-0000-0000-0000-000000000000","type":"","owner_id":"00000000-0000-0000-0000-000000000000","participant_ids":null,"name":"","detail":"","tm_create":"2020-09-20T03:23:21.995000","tm_update":"","tm_delete":""}],"next_page_token":"2020-09-20T03:23:21.995000"}`,
		},
		{
			"more than 2 items",
			cscustomer.Customer{
...
func Test_chatroomsIDGET(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			`{"id":"5585fce6-38a1-11ed-93f2-c396374122fd","customer_id":"00000000-0000-0000-0000-000000000000","type":"","owner_id":"00000000-0000-0000-0000-000000000000","participant_ids":null,"name":"","detail":"","tm_create":"","tm_update":"","tm_delete":""}`,
		},
	}
...
func Test_chatroomsIDDELETE(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			`{"id":"98799008-38a1-11ed-9406-6fa22402722c","customer_id":"00000000-0000-0000-0000-000000000000","type":"","owner_id":"00000000-0000-0000-0000-000000000000","participant_ids":null,"name":"","detail":"","tm_create":"","tm_update":"","tm_delete":""}`,
		},
	}

	...
	tests := []test{
		{
			...
			`{"result":[{"id":"44f67330-bf09-11ed-aba5-3bca63e6a7b4","customer_id":"00000000-0000-0000-0000-000000000000","source":null,"destinations":null,"ring_method":"","answer_method":"","answer_call_id":"00000000-0000-0000-0000-000000000000","call_ids":null,"tm_create":"2020-09-20T03:23:21.995000","tm_update":"","tm_delete":""},{"id":"45364456-bf09-11ed-93aa-53f6a09e7fc1","customer_id":"00000000-0000-0000-0000-000000000000","source":null,"destinations":null,"ring_method":"","answer_method":"","answer_call_id":"00000000-0000-0000-0000-000000000000","call_ids":null,"tm_create":"2020-09-20T03:23:21.995000","tm_update":"","tm_delete":""}],"next_page_token":"2020-09-20T03:23:21.995000"}`,
		},
	}
...
func Test_groupcallsIDGET(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			`{"id":"c1423b7c-bf09-11ed-a3f8-cb3f5a42b528","customer_id":"00000000-0000-0000-0000-000000000000","source":null,"destinations":null,"ring_method":"","answer_method":"","answer_call_id":"00000000-0000-0000-0000-000000000000","call_ids":null,"tm_create":"","tm_update":"","tm_delete":""}`,
		},
	}
...
func Test_groupcallsIDHangupPOST(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			`{"id":"0410089e-bf0a-11ed-93b7-f3a49f2b479f","customer_id":"00000000-0000-0000-0000-000000000000","source":null,"destinations":null,"ring_method":"","answer_method":"","answer_call_id":"00000000-0000-0000-0000-000000000000","call_ids":null,"tm_create":"","tm_update":"","tm_delete":""}`,
		},
	}
...
func Test_groupcallsIDDELETE(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			`{"id":"487fd892-bf0a-11ed-9f7c-b3eaa708de0a","customer_id":"00000000-0000-0000-0000-000000000000","source":null,"destinations":null,"ring_method":"","answer_method":"","answer_call_id":"00000000-0000-0000-0000-000000000000","call_ids":null,"tm_create":"","tm_update":"","tm_delete":""}`,
		},
	}

...
func (mr *MockExternalMediaHandlerMockRecorder) Start(ctx, referenceType, referenceID, insertMedia, externalHost, encapsulation, transport, connectionType, format, direction any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

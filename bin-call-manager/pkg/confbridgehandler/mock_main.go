...
func (mr *MockConfbridgeHandlerMockRecorder) ExternalMediaStart(ctx, id, externalHost, encapsulation, transport, connectionType, format, direction any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
func (m *MockRecordingHandler) Start(ctx context.Context, activeflowID uuid.UUID, referenceType recording.ReferenceType, referenceID uuid.UUID, format recording.Format, endOfSilence int, endOfKey string, duration int, onEndFlowID uuid.UUID) (*recording.Recording, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Start", ctx, activeflowID, referenceType, referenceID, format, endOfSilence, endOfKey, duration, onEndFlowID)
	ret0, _ := ret[0].(*recording.Recording)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRecordingHandlerMockRecorder) Start(ctx, activeflowID, referenceType, referenceID, format, endOfSilence, endOfKey, duration, onEndFlowID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockRecordingHandler)(nil).Start), ctx, activeflowID, referenceType, referenceID, format, endOfSilence, endOfKey, duration, onEndFlowID)
}

...
//
//	mockgen -package bridgehandler -destination ./mock_main.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockBridgeHandlerMockRecorder) AddChannelID(ctx, id, channelID any) *gomock.Call {
...
func (mr *MockBridgeHandlerMockRecorder) ChannelJoin(ctx, id, channelID, role, absorbDTMF, mute any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBridgeHandlerMockRecorder) ChannelKick(ctx, id, channelID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBridgeHandlerMockRecorder) Create(ctx, asteriskID, id, name, bridgeType, tech, class, creator, videoMode, videoSourceID, referenceType, referenceID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBridgeHandlerMockRecorder) Delete(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBridgeHandlerMockRecorder) Destroy(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBridgeHandlerMockRecorder) Get(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBridgeHandlerMockRecorder) IsExist(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBridgeHandlerMockRecorder) RemoveChannelID(ctx, id, channelID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBridgeHandlerMockRecorder) Start(ctx, asteriskID, bridgeID, bridgeName, bridgeType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

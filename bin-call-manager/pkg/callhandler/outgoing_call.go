...
func (h *callHandler) CreateCallOutgoing(
	...
	// create activeflow
	af, err := h.reqHandler.FlowV1ActiveflowCreate(ctx, activeflowID, customerID, flowID, fmactiveflow.ReferenceTypeCall, id, uuid.Nil, variables, "", fmactiveflow.WebhookMethodNone)
	if err != nil {

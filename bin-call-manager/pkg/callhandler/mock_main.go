...
func (m *MockCallHandler) CreateCallOutgoing(ctx context.Context, id, customerID, flowID, activeflowID, masterCallID, groupcallID uuid.UUID, source, destination address.Address, earlyExecution, connect bool, anonymous string) (*call.Call, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCallOutgoing", ctx, id, customerID, flowID, activeflowID, masterCallID, groupcallID, source, destination, earlyExecution, connect, anonymous)
	ret0, _ := ret[0].(*call.Call)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCallHandlerMockRecorder) CreateCallOutgoing(ctx, id, customerID, flowID, activeflowID, masterCallID, groupcallID, source, destination, earlyExecution, connect, anonymous any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCallOutgoing", reflect.TypeOf((*MockCallHandler)(nil).CreateCallOutgoing), ctx, id, customerID, flowID, activeflowID, masterCallID, groupcallID, source, destination, earlyExecution, connect, anonymous)
}

// CreateCallsOutgoing mocks base method.
func (m *MockCallHandler) CreateCallsOutgoing(ctx context.Context, customerID, flowID, masterCallID uuid.UUID, source address.Address, destinations []address.Address, earlyExecution, connect bool, anonymous string) ([]*call.Call, []*groupcall.Groupcall, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCallsOutgoing", ctx, customerID, flowID, masterCallID, source, destinations, earlyExecution, connect, anonymous)
	ret0, _ := ret[0].([]*call.Call)
...
func (mr *MockCallHandlerMockRecorder) CreateCallsOutgoing(ctx, customerID, flowID, masterCallID, source, destinations, earlyExecution, connect, anonymous any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCallsOutgoing", reflect.TypeOf((*MockCallHandler)(nil).CreateCallsOutgoing), ctx, customerID, flowID, masterCallID, source, destinations, earlyExecution, connect, anonymous)
}

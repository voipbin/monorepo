...
//
//	mockgen -package groupcallhandler -destination ./mock_main.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockGroupcallHandlerMockRecorder) AnswerCall(ctx, groupcallID, answerCallID any) *gomock.Call {
...
func (mr *MockGroupcallHandlerMockRecorder) AnswerGroupcall(ctx, id, answerGroupcallID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupcallHandlerMockRecorder) Delete(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupcallHandlerMockRecorder) EventCUCustomerDeleted(ctx, cu any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupcallHandlerMockRecorder) Get(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupcallHandlerMockRecorder) Hangingup(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupcallHandlerMockRecorder) HangupCall(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupcallHandlerMockRecorder) HangupGroupcall(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockGroupcallHandler) Start(ctx context.Context, id, customerID, flowID uuid.UUID, source *address.Address, destinations []address.Address, masterCallID, masterGroupcallID uuid.UUID, ringMethod groupcall.RingMethod, answerMethod groupcall.AnswerMethod, anonymous string) (*groupcall.Groupcall, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Start", ctx, id, customerID, flowID, source, destinations, masterCallID, masterGroupcallID, ringMethod, answerMethod, anonymous)
	ret0, _ := ret[0].(*groupcall.Groupcall)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockGroupcallHandlerMockRecorder) Start(ctx, id, customerID, flowID, source, destinations, masterCallID, masterGroupcallID, ringMethod, answerMethod, anonymous any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockGroupcallHandler)(nil).Start), ctx, id, customerID, flowID, source, destinations, masterCallID, masterGroupcallID, ringMethod, answerMethod, anonymous)
}
...
func (mr *MockGroupcallHandlerMockRecorder) UpdateAnswerCallID(ctx, id, callID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

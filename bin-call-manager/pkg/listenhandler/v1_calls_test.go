...
func Test_processV1CallsIDExternalMediaDelete(t *testing.T) {
	...
	tests := []test{
		{
			...
			request: &sock.Request{
				...
				Method:   sock.RequestMethodDelete,
				DataType: "application/json",
				Data:     []byte(`{"external_media_id":"a1b2c3d4-9730-11ed-bd80-a764f6bc382e"}`),
			},
			...
			expectExternalMediaID: uuid.FromStringOrNil("a1b2c3d4-9730-11ed-bd80-a764f6bc382e"),
			expectRes: &sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockCall.EXPECT().ExternalMediaStop(context.Background(), tt.expectCallID, tt.expectExternalMediaID).Return(tt.responseCall, nil)
	...
	tests := []struct {
	...
	}{
		{
			...
			expectRes: &sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"638769c2-620d-11eb-bd1f-6b576e26b4e6","customer_id":"ab0fb69e-7f50-11ec-b0d3-2b4311e649e0","owner_type":"","owner_id":"00000000-0000-0000-0000-000000000000","flow_id":"00000000-0000-0000-0000-000000000000","activeflow_id":"00000000-0000-0000-0000-000000000000","confbridge_id":"68e9edd8-3609-11ec-ad76-b72fa8f57f23","master_call_id":"00000000-0000-0000-0000-000000000000","recording_id":"00000000-0000-0000-0000-000000000000","groupcall_id":"00000000-0000-0000-0000-000000000000","source":{},"destination":{},"action":{"id":"00000000-0000-0000-0000-000000000000","next_id":"00000000-0000-0000-0000-000000000000","tm_execute":null},"dialroute_id":"00000000-0000-0000-0000-000000000000"}`),
			},
		},
	}

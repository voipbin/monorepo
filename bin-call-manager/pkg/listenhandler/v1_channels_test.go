...
func Test_processV1ChannelsIDHealthPost(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			channelID:     "f1f90a0a-9844-11ea-8948-5378837e7179",
			retryCount:    0,
			retryCountMax: 2,
			delay:         10000,
		},
		{
			name: "channel id is not uuid",
			...
			asteriskID:    "42:01:0a:a4:00:05",
			channelID:     "asterisk-call-58f54b64c7-d7sv7-1676744879.1115",
			retryCount:    0,
			retryCountMax: 2,
			delay:         10000,
		},

...
// Test_topicPatterns_golden pins the EXACT bind set of schedule-manager on the global
...
func Test_topicPatterns_golden(t *testing.T) {
	...
	// design §5: schedule-manager binds exactly 1 pattern.
...
// Test_fanoutUnbindTargets_golden pins the fanout exchanges schedule-manager unbinds
// after a fully successful topic bind (VOIP-1406). This is the FULL subscribeTargets set
// wired in cmd/schedule-manager: the single customer-manager event exchange.

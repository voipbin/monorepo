...
create index idx_schedule_schedules_customer_name on schedule_schedules(customer_id, name);
create index idx_schedule_schedules_next_run on schedule_schedules(enabled, tm_next_run);

...
const OutplansList = () => {
  ...
  const Detail = (row) => {
    const target = "/resources/outplans/outplans_detail/" + row.original.id;
    console.log("navigate target: ", target);
    navigate(target);
  }
  const Create = () => {
    const target = "/resources/outplans/outplans_create";
    console.log("navigate target: ", target);
    navigate(target);
  }

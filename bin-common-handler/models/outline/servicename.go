...
const (
	...
	ServiceNameContactManager      ServiceName = "contact-manager"
	ServiceNameConferenceManager   ServiceName = "conference-manager"
	ServiceNameConversationManager ServiceName = "conversation-manager"
	...
	ServiceNameSchedulerManager  ServiceName = "scheduler-manager"

...
func (mr *MockSockHandlerMockRecorder) ConsumeMessage(queueName, consumerName, exclusive, noLocal, noWait, numWorkers, messageConsume interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSockHandlerMockRecorder) ConsumeRPC(queueName, consumerName, exclusive, noLocal, noWait, workerNum, cbConsume interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSockHandlerMockRecorder) EventPublish(topic, key, evt interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSockHandlerMockRecorder) EventPublishWithDelay(topic, key, evt, delay interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSockHandlerMockRecorder) QueueCreate(name, queueType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSockHandlerMockRecorder) QueueSubscribe(name, topic interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSockHandlerMockRecorder) RequestPublish(ctx, queueName, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSockHandlerMockRecorder) RequestPublishWithDelay(queueName, req, delay interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSockHandlerMockRecorder) TopicCreate(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

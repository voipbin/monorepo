...
// Source: pkg/requesthandler/main.go
//
// Generated by this command:
//
//	mockgen -package requesthandler -destination ./pkg/requesthandler/mock_main.go -source pkg/requesthandler/main.go -build_flags=-mod=mod
//

...
func (m *MockRequestHandler) AIV1AIcallToolExecute(ctx context.Context, aicallID uuid.UUID, toolID string, toolType message.ToolType, function *message.FunctionCall, pipecatcallID uuid.UUID) (map[string]any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AIV1AIcallToolExecute", ctx, aicallID, toolID, toolType, function, pipecatcallID)
...
// AIV1SummaryRegenerate mocks base method.
func (m *MockRequestHandler) AIV1SummaryRegenerate(ctx context.Context, summaryID uuid.UUID, language string) (*summary.Summary, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AIV1SummaryRegenerate", ctx, summaryID, language)
	ret0, _ := ret[0].(*summary.Summary)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AIV1SummaryRegenerate indicates an expected call of AIV1SummaryRegenerate.
func (mr *MockRequestHandlerMockRecorder) AIV1SummaryRegenerate(ctx, summaryID, language any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AIV1SummaryRegenerate", reflect.TypeOf((*MockRequestHandler)(nil).AIV1SummaryRegenerate), ctx, summaryID, language)
}

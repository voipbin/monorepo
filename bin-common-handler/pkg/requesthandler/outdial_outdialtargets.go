...
func (r *requestHandler) OutdialV1OutdialtargetCreate(
	...
	tmp, err := r.sendRequestOutdial(ctx, uri, sock.RequestMethodPost, "outdial/outdial_targets", requestTimeoutDefault, 0, ContentTypeJSON, m)
	if err != nil {
		return nil, err
	}
...
func (r *requestHandler) OutdialV1OutdialtargetDelete(ctx context.Context, outdialtargetID uuid.UUID) (*omoutdialtarget.OutdialTarget, error) {
	...
	tmp, err := r.sendRequestOutdial(ctx, uri, sock.RequestMethodDelete, "outdial/outdial_targets", requestTimeoutDefault, 0, ContentTypeJSON, nil)
	if err != nil {
		return nil, err
	}
...
func (r *requestHandler) OutdialV1OutdialtargetGet(ctx context.Context, outdialtargetID uuid.UUID) (*omoutdialtarget.OutdialTarget, error) {
	...
	tmp, err := r.sendRequestOutdial(ctx, uri, sock.RequestMethodGet, "outdial/outdial_targets", requestTimeoutDefault, 0, ContentTypeJSON, nil)
	if err != nil {
		return nil, err
	}

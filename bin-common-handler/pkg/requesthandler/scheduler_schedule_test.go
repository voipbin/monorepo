...
func Test_SchedulerV1ScheduleCreate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectTarget: "bin-manager.scheduler-manager.request",
			expectRequest: &sock.Request{
				URI:      "/v1/schedules",
		...
		},
		{
			...
			expectRequest: &sock.Request{
				...
				Method:   sock.RequestMethodPost,
				DataType: ContentTypeJSON,
				Data:     []byte(`{"customer_id":"164fce88-6f15-11f0-b552-3f8cf3b2e552","name":"database-backup","detail":"nightly database backup","cron":"0 3 * * *","target_queue":"bin-manager.scheduler-manager.request","target_uri":"/v1/backups","target_method":"POST","target_data_type":"","target_data":null,"timeout_ms":1800000,"retry_max":1,"enabled":false}`),
			},
			response: &sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := reqHandler.SchedulerV1ScheduleCreate(ctx, tt.customerID, tt.scheduleName, tt.detail, tt.cronExpr, tt.targetQueue, tt.targetURI, tt.targetMethod, tt.targetDataType, tt.targetData, tt.timeoutMS, tt.retryMax, tt.enabled)
			if err != nil {
...
func Test_SchedulerV1ScheduleGet(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := reqHandler.SchedulerV1ScheduleGet(ctx, tt.id)
			if err != nil {
				t.Errorf("Wrong match. expect: ok, got: %v", err)
			}
...
func Test_SchedulerV1ScheduleGets(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := reqHandler.SchedulerV1ScheduleGets(ctx, tt.pageToken, tt.pageSize, tt.filters)
			if err != nil {
				t.Errorf("Wrong match. expect: ok, got: %v", err)
			}
...
func Test_SchedulerV1ScheduleUpdate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := reqHandler.SchedulerV1ScheduleUpdate(ctx, tt.id, tt.fields)
			if err != nil {
				t.Errorf("Wrong match. expect: ok, got: %v", err)
			}
...
func Test_SchedulerV1ScheduleDelete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := reqHandler.SchedulerV1ScheduleDelete(ctx, tt.id)
			if err != nil {
				t.Errorf("Wrong match. expect: ok, got: %v", err)
			}
...
func Test_SchedulerV1ScheduleExecute(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := reqHandler.SchedulerV1ScheduleExecute(ctx, tt.id)
			if err != nil {
				t.Errorf("Wrong match. expect: ok, got: %v", err)
			}
...
func Test_SchedulerV1ExecutionGets(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := reqHandler.SchedulerV1ExecutionGets(ctx, tt.pageToken, tt.pageSize, tt.filters)
			if err != nil {
				t.Errorf("Wrong match. expect: ok, got: %v", err)
			}

...
func (r *requestHandler) AstChannelAnswer(ctx context.Context, asteriskID, channelID string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsAnswer, requestTimeoutDefault, 0, "", nil)
	switch {
	case err != nil:
		return err
...
func (r *requestHandler) AstChannelContinue(ctx context.Context, asteriskID, channelID, context, ext string, pri int, label string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsContinue, requestTimeoutDefault, 0, ContentTypeJSON, m)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelHangup(ctx context.Context, asteriskID, channelID string, code cmari.ChannelCause, delay int) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodDelete, resourceAstChannelsHangup, requestTimeoutDefault, delay, ContentTypeJSON, m)
	switch {
	case err != nil:
		return err
	case res == nil:
...
func (r *requestHandler) AstChannelVariableGet(ctx context.Context, asteriskID, channelID, variable string) (string, error) {
	...
	tmp, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodGet, resourceAstChannelsVar, requestTimeoutDefault, 0, ContentTypeJSON, nil)
	switch {
	case err != nil:
		return "", err
...
func (r *requestHandler) AstChannelVariableSet(ctx context.Context, asteriskID, channelID, variable, value string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsVar, requestTimeoutDefault, 0, ContentTypeJSON, m)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelDTMF(ctx context.Context, asteriskID, channelID string, digit string, duration, before, between, after int) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsHangup, requestTimeoutDefault, 0, ContentTypeJSON, m)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelDial(ctx context.Context, asteriskID, channelID, caller string, timeout int) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsDial, requestTimeoutDefault, 0, ContentTypeJSON, m)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelPlay(ctx context.Context, asteriskID string, channelID string, actionID uuid.UUID, medias []string, lang string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsPlay, 10000, 0, ContentTypeJSON, m)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelRecord(ctx context.Context, asteriskID string, channelID string, filename string, format string, duration int, silence int, beep bool, endKey string, ifExists string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsRecord, 10000, 0, ContentTypeJSON, m)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelExternalMedia(ctx context.Context, asteriskID string, channelID string, externalHost string, encapsulation string, transport string, connectionType string, format string, direction string, data string, variables map[string]string) (*cmchannel.Channel, error) {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsExternalMedia, 10000, 0, ContentTypeJSON, m)
	switch {
	case err != nil:
		return nil, err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelRing(ctx context.Context, asteriskID string, channelID string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsExternalMedia, requestTimeoutDefault, 0, ContentTypeJSON, nil)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelHoldOn(ctx context.Context, asteriskID string, channelID string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsHold, requestTimeoutDefault, 0, ContentTypeNone, nil)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelHoldOff(ctx context.Context, asteriskID string, channelID string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodDelete, resourceAstChannelsHold, requestTimeoutDefault, 0, ContentTypeNone, nil)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelMusicOnHoldOn(ctx context.Context, asteriskID string, channelID string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsMOH, requestTimeoutDefault, 0, ContentTypeNone, nil)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelMusicOnHoldOff(ctx context.Context, asteriskID string, channelID string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodDelete, resourceAstChannelsMOH, requestTimeoutDefault, 0, ContentTypeNone, nil)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelSilenceOn(ctx context.Context, asteriskID string, channelID string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsSilence, requestTimeoutDefault, 0, ContentTypeNone, nil)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelSilenceOff(ctx context.Context, asteriskID string, channelID string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodDelete, resourceAstChannelsSilence, requestTimeoutDefault, 0, ContentTypeNone, nil)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelMuteOn(ctx context.Context, asteriskID string, channelID string, direction string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodPost, resourceAstChannelsMute, requestTimeoutDefault, 0, ContentTypeJSON, m)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:
...
func (r *requestHandler) AstChannelMuteOff(ctx context.Context, asteriskID string, channelID string, direction string) error {
	...
	res, err := r.sendRequestAst(ctx, asteriskID, url, rabbitmqhandler.RequestMethodDelete, resourceAstChannelsMute, requestTimeoutDefault, 0, ContentTypeJSON, m)
	switch {
	case err != nil:
		return err
	case res.StatusCode > 299:

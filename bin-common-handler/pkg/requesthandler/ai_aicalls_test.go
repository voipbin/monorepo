...
func Test_AIV1AIcallStart(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectRequest: &sock.Request{
				...
				DataType: "application/json",
				Data:     []byte(`{"id":"00000000-0000-0000-0000-000000000000","assistance_type":"ai","assistance_id":"e8604e8a-ef52-11ef-88be-43d681e412f7","activeflow_id":"eb23a6b0-0cc3-11f0-8150-0f33dc4cfdc4","reference_type":"call","reference_id":"e8c3a34a-ef52-11ef-b4d1-93c7d17c08e9"}`),
			},
			expectRes: &amaicall.AIcall{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			cf, err := reqHandler.AIV1AIcallStart(ctx, uuid.Nil, tt.assistanceType, tt.assistanceID, tt.activeflowID, tt.referenceType, tt.referenceID)
			if err != nil {

...
func (r *requestHandler) SendRequest(ctx context.Context, queue commonoutline.QueueName, uri string, method rabbitmqhandler.RequestMethod, timeout int, delay int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout: timeout(ms)
// delayed: delay request(ms)
func (r *requestHandler) sendRequest(ctx context.Context, queue commonoutline.QueueName, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout int, delay int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
func (r *requestHandler) sendDirectRequest(ctx context.Context, target string, resource string, req *rabbitmqhandler.Request) (*rabbitmqhandler.Response, error) {
...
func (r *requestHandler) sendDelayedRequest(queue string, resource string, delay int, req *rabbitmqhandler.Request) error {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestAst(ctx context.Context, asteriskID, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout int, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestFlow(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout int, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestTTS(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout int, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestWebhook(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout int, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestCall(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
func (r *requestHandler) sendRequestRegistrar(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout int, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
func (r *requestHandler) sendRequestNumber(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout int, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
func (r *requestHandler) sendRequestConference(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout int, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestTranscribe(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestStorage(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestAgent(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestQueue(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestCustomer(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestMessage(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestOutdial(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestCampaign(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestConversation(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestChat(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
func (r *requestHandler) sendRequestRoute(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout int, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestChatbot(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestTransfer(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data json.RawMessage) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestBilling(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {
...
// timeout millisecond
// delayed millisecond
func (r *requestHandler) sendRequestTag(ctx context.Context, uri string, method rabbitmqhandler.RequestMethod, resource string, timeout, delayed int, dataType string, data []byte) (*rabbitmqhandler.Response, error) {

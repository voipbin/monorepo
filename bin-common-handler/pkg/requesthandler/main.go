...
const (
	// "call/calls"                      resource = "call/calls"
	// "call/calls/<call-id>/action-next"      resource = "call/calls/<call-id>/action-next"
	// "call/calls/<call-id>/action-timeout"   resource = "call/calls/<call-id>/action-timeout"
	// "call/calls/health"                resource = "call/calls/health"
	// "call/calls/<call-id>/recording-start"  resource = "call/calls/<call-id>/recording-start"
	// "call/calls/<call-id>/recording-stop"   resource = "call/calls/<call-id>/recording-stop"
	// "call/calls/<call-id>/confbirdge_id"    resource = "call/calls/<call-id>/confbirdge_id"
	// "call/calls/<call-id>/external-media"   resource = "call/calls/<call-id>/external-media"
	// "call/calls/<call-id>/talk"            resource = "call/calls/<call-id>/talk"
	// "call/calls/<call-id>/play"            resource = "call/calls/<call-id>/play"
	// "call/calls/<call-id>/hold"            resource = "call/calls/<call-id>/hold"
	// "call/calls/<call-id>/moh"             resource = "call/calls/<call-id>/moh"
	// "call/calls/<call-id>/mute"            resource = "call/calls/<call-id>/mute"
	// "call/calls/<call-id>/silence"         resource = "call/calls/<call-id>/silence"
	// "call/channels/health"             resource = "call/channels/health"
	// "call/confbridges"                resource = "call/confbridges"
	// "call/confbridges/<confbridge-id>/external-media" resource = "call/confbridges/<confbridge-id>/external-media"
	// "call/confbridges/<confbridge-id>/recording-start"  resource = "call/confbridges/<confbridge-id>/recording-start"
	// "call/confbridges/<confbridge-id>/recording-stop"   resource = "call/confbridges/<confbridge-id>/recording-stop"
	// "call/groupcalls"                 resource = "call/groupcalls"
	// "call/groupcalls/<groupcall-id>"               resource = "call/groupcalls/<groupcall-id>"
	// "call/groupcalls/<groupcall-id>/hangup"         resource = "call/groupcalls/<groupcall-id>/hangup"
	// "call/recordings"                 resource = "call/recordings"
	// "call/external-medias"              resource = "call/external-medias"
...
type RequestHandler interface {
	...
	CallV1ExternalMediaStart(ctx context.Context, referenceType cmexternalmedia.ReferenceType, referenceID uuid.UUID, noInsertMedia bool, externalHost string, encapsulation string, transport string, connectionType string, format string, direction string) (*cmexternalmedia.ExternalMedia, error)

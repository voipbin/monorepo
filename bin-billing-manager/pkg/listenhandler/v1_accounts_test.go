	...
	tests := []test{
		{
			...
			expectRes: &sock.Response{
				...
				Data:       []byte(`[{"id":"dafc10d0-0b97-11ee-af30-2fb7811295dd","customer_id":"00000000-0000-0000-0000-000000000000","name":"","detail":"","plan_type":"","balance":0,"payment_type":"","payment_method":"","tm_create":null,"tm_update":null,"tm_delete":null},{"id":"db4e7e24-0b97-11ee-91f9-c7d5620abcd7","customer_id":"00000000-0000-0000-0000-000000000000","name":"","detail":"","plan_type":"","balance":0,"payment_type":"","payment_method":"","tm_create":null,"tm_update":null,"tm_delete":null}]`),
			},
		},
	}
	...
	tests := []test{
		{
			...
			expectRes: &sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"c28443b6-0e75-11ee-90ec-1bb28081d375","customer_id":"00000000-0000-0000-0000-000000000000","name":"","detail":"","plan_type":"","balance":0,"payment_type":"","payment_method":"","tm_create":null,"tm_update":null,"tm_delete":null}`),
			},
		},
	}
	...
	tests := []test{
		{
			...
			expectRes: &sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"a9e3587c-4ccf-11ee-9872-8b9300051977","customer_id":"00000000-0000-0000-0000-000000000000","name":"","detail":"","plan_type":"","balance":0,"payment_type":"","payment_method":"","tm_create":null,"tm_update":null,"tm_delete":null}`),
			},
		},
	}

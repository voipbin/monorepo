...
func (mr *MockCacheHandlerMockRecorder) AccountGetByCustomerID(ctx, customerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) AccountSet(ctx, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) BillingGet(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) BillingGetByReferenceID(ctx, referenceID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) BillingSet(ctx, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

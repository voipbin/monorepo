...
//
//	mockgen -package listenhandler -destination ./mock_listenhandler.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockListenHandlerMockRecorder) Run(queue, exchangeDelay any) *gomock.Call {

...
//
//	mockgen -package webhookhandler -destination ./mock_webhookhandler.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockWebhookHandlerMockRecorder) SendWebhookToCustomer(ctx, customerID, dataType, data any) *gomock.Call {
...
func (mr *MockWebhookHandlerMockRecorder) SendWebhookToURI(ctx, customerID, uri, method, dataType, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

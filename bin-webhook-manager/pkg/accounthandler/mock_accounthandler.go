...
//
//	mockgen -package accounthandler -destination ./mock_accounthandler.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockAccountHandlerMockRecorder) Update(ctx, m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountHandlerMockRecorder) UpdateByCustomer(ctx, m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

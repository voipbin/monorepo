...
// Source: ./pkg/agenthandler/main.go
//
// Generated by this command:
//
//	mockgen -package agenthandler -destination ./pkg/agenthandler/mock_main.go -source ./pkg/agenthandler/main.go -build_flags=-mod=mod
//

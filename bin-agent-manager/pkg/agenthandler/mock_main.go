...
func (m *MockAgentHandler) DirectHashRegenerate(ctx context.Context, id uuid.UUID) (*agent.Agent, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAgentHandlerMockRecorder) DirectHashRegenerate(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DirectHashRegenerate", reflect.TypeOf((*MockAgentHandler)(nil).DirectHashRegenerate), ctx, id)
}

// EventCustomerCreated mocks base method.
func (m *MockAgentHandler) EventCustomerCreated(ctx context.Context, cu *customer.Customer, headless bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EventCustomerCreated", ctx, cu, headless)
	ret0, _ := ret[0].(error)
	return ret0
}

// EventCustomerCreated indicates an expected call of EventCustomerCreated.
func (mr *MockAgentHandlerMockRecorder) EventCustomerCreated(ctx, cu, headless any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EventCustomerCreated", reflect.TypeOf((*MockAgentHandler)(nil).EventCustomerCreated), ctx, cu, headless)
}
...
func (m *MockAgentHandler) Reserve(ctx context.Context, agentID uuid.UUID, refType string, refID uuid.UUID) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Reserve", ctx, agentID, refType, refID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAgentHandlerMockRecorder) Reserve(ctx, agentID, refType, refID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Reserve", reflect.TypeOf((*MockAgentHandler)(nil).Reserve), ctx, agentID, refType, refID)
}

// ReserveRelease mocks base method.
func (m *MockAgentHandler) ReserveRelease(ctx context.Context, agentID, refID uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReserveRelease", ctx, agentID, refID)
	ret0, _ := ret[0].(error)
	return ret0
}

// ReserveRelease indicates an expected call of ReserveRelease.
func (mr *MockAgentHandlerMockRecorder) ReserveRelease(ctx, agentID, refID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReserveRelease", reflect.TypeOf((*MockAgentHandler)(nil).ReserveRelease), ctx, agentID, refID)
}

// ReserveSweep mocks base method.
func (m *MockAgentHandler) ReserveSweep(ctx context.Context, before time.Time) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReserveSweep", ctx, before)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReserveSweep indicates an expected call of ReserveSweep.
func (mr *MockAgentHandlerMockRecorder) ReserveSweep(ctx, before any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReserveSweep", reflect.TypeOf((*MockAgentHandler)(nil).ReserveSweep), ctx, before)
}

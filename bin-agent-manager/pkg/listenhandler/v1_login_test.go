	...
	tests := []struct {
	...
	}{
		{
			...
			expectRes: &sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"e58a9424-7dc0-11ec-82b6-d387115f2157","customer_id":"00000000-0000-0000-0000-000000000000","username":"test@test.com","name":"","detail":"","ring_method":"","status":"","permission":0,"tag_ids":null,"addresses":null}`),
			},
		},
	}

...
func (m *MockListenHandler) Run(queue string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Run", queue)
	ret0, _ := ret[0].(error)
	return ret0
}

// Run indicates an expected call of Run.
func (mr *MockListenHandlerMockRecorder) Run(queue any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Run", reflect.TypeOf((*MockListenHandler)(nil).Run), queue)
}

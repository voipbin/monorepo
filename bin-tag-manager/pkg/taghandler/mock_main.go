...
func (mr *MockTagHandlerMockRecorder) Delete(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTagHandlerMockRecorder) EventCustomerDeleted(ctx, c interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTagHandlerMockRecorder) Get(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTagHandlerMockRecorder) UpdateBasicInfo(ctx, id, name, detail interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

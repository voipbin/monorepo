...
func (mr *MockContactHandlerMockRecorder) ContactGetsByExtension(ctx, customerID, ext any) *gomock.Call {
...
func (mr *MockContactHandlerMockRecorder) ContactRefreshByEndpoint(ctx, customerID, ext any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

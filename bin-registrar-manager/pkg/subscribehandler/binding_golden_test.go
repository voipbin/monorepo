...
// Test_topicPatterns_golden pins the EXACT bind set of registrar-manager on the global
...
func Test_topicPatterns_golden(t *testing.T) {
	...
	// design §5: registrar-manager binds exactly 2 patterns.
...
// Test_fanoutUnbindTargets_golden pins the fanout exchanges registrar-manager unbinds
// after a fully successful topic bind (VOIP-1406). This is the FULL subscribeTargets set
// wired in cmd/registrar-manager: the single customer-manager fanout event exchange.

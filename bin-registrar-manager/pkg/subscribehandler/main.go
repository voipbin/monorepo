...
func (h *subscribeHandler) Run() error {
	...
	go func() {
		for {
			if errConsume := h.rabbitSock.ConsumeMessageOpt(h.subscribeQueue, string(commonoutline.ServiceNameRegistrarManager), false, false, false, 10, h.processEventRun); errConsume != nil {

	...
	tests := []test{
		{
			...
			expectRes: &sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`[{"id":"c3bb89e8-6f4d-11eb-b0dc-2f9c1d06a8ec","customer_id":"2e341ffa-7fed-11ec-9667-1357b91d745d","name":"","detail":"","endpoint_id":"","aor_id":"","auth_id":"","extension":"","domain_name":"","realm":"","username":"","password":"","direct_id":"00000000-0000-0000-0000-000000000000","direct_hash":"","tm_create":null,"tm_update":null,"tm_delete":null},{"id":"c4fb2336-6f4d-11eb-b51d-b318fdb3e042","customer_id":"2e341ffa-7fed-11ec-9667-1357b91d745d","name":"","detail":"","endpoint_id":"","aor_id":"","auth_id":"","extension":"","domain_name":"","realm":"","username":"","password":"","direct_id":"00000000-0000-0000-0000-000000000000","direct_hash":"","tm_create":null,"tm_update":null,"tm_delete":null}]`),
			},
		},
		{
			name: "empty",
	...
	tests := []test{
		{
			...
			&sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"6dc9dd22-6f4e-11eb-8059-2fe116db7a2b","customer_id":"2e341ffa-7fed-11ec-9667-1357b91d745d","name":"update name","detail":"update detail","endpoint_id":"","aor_id":"","auth_id":"","extension":"","domain_name":"","realm":"","username":"","password":"update password","direct_id":"00000000-0000-0000-0000-000000000000","direct_hash":"","tm_create":null,"tm_update":null,"tm_delete":null}`),
			},
		},
	}
	...
	tests := []test{
		{
			...
			&sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"adeea2b0-6f4f-11eb-acb7-13291c18927b","customer_id":"00000000-0000-0000-0000-000000000000","name":"","detail":"","endpoint_id":"","aor_id":"","auth_id":"","extension":"","domain_name":"","realm":"","username":"","password":"","direct_id":"00000000-0000-0000-0000-000000000000","direct_hash":"","tm_create":null,"tm_update":null,"tm_delete":null}`),
			},
		},
	}
	...
	tests := []test{
		{
			...
			&sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"922a32a2-5650-11ee-8341-cb03501d873e","customer_id":"00000000-0000-0000-0000-000000000000","name":"","detail":"","endpoint_id":"","aor_id":"","auth_id":"","extension":"","domain_name":"","realm":"","username":"","password":"","direct_id":"00000000-0000-0000-0000-000000000000","direct_hash":"","tm_create":null,"tm_update":null,"tm_delete":null}`),
			},
		},
	}

...
func (mr *MockOutdialHandlerMockRecorder) Create(ctx, customerID, campaignID, name, detail, data interface{}) *gomock.Call {
...
func (mr *MockOutdialHandlerMockRecorder) Get(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOutdialHandlerMockRecorder) GetsByCustomerID(ctx, customerID, token, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOutdialHandlerMockRecorder) UpdateBasicInfo(ctx, id, name, detail interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOutdialHandlerMockRecorder) UpdateCampaignID(ctx, id, campaignID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOutdialHandlerMockRecorder) UpdateData(ctx, id, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
```
cd existing_repo
git remote add origin https://gitlab.com/voipbin/bin-manager/agent-manager.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:c434baf4327733a385ac3e01fbe37b88?https://gitlab.com/voipbin/bin-manager/agent-manager/-/settings/integrations)

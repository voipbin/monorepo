...
func (m *MockNotifyHandler) PublishEvent(event any) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PublishEvent", event)
	ret0, _ := ret[0].(error)
	return ret0
}

// PublishEvent indicates an expected call of PublishEvent.
func (mr *MockNotifyHandlerMockRecorder) PublishEvent(event any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublishEvent", reflect.TypeOf((*MockNotifyHandler)(nil).PublishEvent), event)
}

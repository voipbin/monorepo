	...
	tests := []struct {
	...
	}{
		{
			...
			responseMessage: &message.Message{
				...
				Text:     "Hello world",
				Medias:   "[]",
				Metadata: `{"reactions":[{"emoji":"👍","owner_type":"agent","owner_id":"7fcd7990-42eb-11ed-9fa6-b4cd93af9796","tm_create":"2021-11-23 17:55:39.712000"}]}`,
		...
		},
		{
			...
			responseMessage: &message.Message{
				...
				Text:     "Hello world",
				Medias:   "[]",
				Metadata: `{"reactions":[{"emoji":"❤️","owner_type":"customer","owner_id":"8ede8b40-86ef-11ed-d4fb-e9e028af9801","tm_create":"2021-11-23 18:00:00.000000"}]}`,
				TMCreate: "2021-11-23 17:55:39.712000",

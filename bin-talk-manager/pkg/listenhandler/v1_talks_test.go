...
func Test_processV1TalksPost(t *testing.T) {
	tests := []struct {
		name    string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := h.v1TalksPost(ctx, *tt.request)
			if err != nil {
...
func Test_processV1TalksPost_error(t *testing.T) {
	tests := []struct {
		name      string
		request   *sock.Request
		expectRes *sock.Response
...
func Test_processV1TalksGet(t *testing.T) {
	tests := []struct {
		name    string
		request *sock.Request
	...
	}{
		{
			name: "normal",
			request: &sock.Request{
				URI:      "/v1/talks?page_size=10&page_token=2021-11-23%2017:55:39.712000",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := h.v1TalksGet(ctx, *tt.request)
			if err != nil {
				t.Errorf("Wrong match. expect: ok, got: %v", err)
			}
...
func Test_processV1TalksIDGet(t *testing.T) {
	tests := []struct {
		name    string
		request *sock.Request
	...
	}{
		{
			name: "normal",
			request: &sock.Request{
				URI:      "/v1/talks/6ebc6880-31da-11ed-8e95-a3bc92af9795",
				Method:   sock.RequestMethodGet,
				DataType: "application/json",
			},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := h.processV1TalksID(ctx, *tt.request)
			if err != nil {
				t.Errorf("Wrong match. expect: ok, got: %v", err)
			}
...
func Test_processV1TalksIDDelete(t *testing.T) {
	tests := []struct {
		name    string
		request *sock.Request
...
func Test_processV1TalksID_unsupported_method(t *testing.T) {
	tests := []struct {
		name      string
		request   *sock.Request
		expectRes *sock.Response

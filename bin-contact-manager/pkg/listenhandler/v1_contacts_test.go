...
func TestProcessV1ContactsPost_WithAddresses(t *testing.T) {
	mc := gomock.NewController(t)
	defer mc.Finish()
	...
	request := &sock.Request{
		...
		Method:   sock.RequestMethodPost,
		DataType: "application/json",
		Data:     []byte(`{"customer_id":"92883d56-7fe3-11ec-8931-37d08180a2b9","first_name":"Jane","addresses":[{"type":"tel","target":"+15551234567","is_primary":true},{"type":"email","target":"jane@example.com","is_primary":false}],"tag_ids":["aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"]}`),
	}

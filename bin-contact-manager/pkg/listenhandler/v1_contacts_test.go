...
func TestProcessV1ContactsGet(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "normal",
			request: &sock.Request{
				URI:      "/v1/contacts?customer_id=92883d56-7fe3-11ec-8931-37d08180a2b9&page_size=10&page_token=2021-11-23%2017:55:39.712000",
	...
	tests := []struct {
	...
	}{
		{
			...
			responseContact: &contact.Contact{
				...
				TMCreate:    "2021-11-23 17:55:39.712000",
				TMUpdate:    "9999-01-01T00:00:00.000000Z",
				TMDelete:    "2021-11-24 10:00:00.000000",
			},
			expectRes: &sock.Response{
				StatusCode: 200,
				DataType:   "application/json",
				Data:       []byte(`{"id":"c31676f0-4e69-11ec-afe3-77ba49fae527","customer_id":"92883d56-7fe3-11ec-8931-37d08180a2b9","first_name":"John","last_name":"Doe","display_name":"John Doe","company":"","job_title":"","source":"manual","external_id":"","notes":"","tm_create":"2021-11-23 17:55:39.712000","tm_update":"9999-01-01T00:00:00.000000Z","tm_delete":"2021-11-24 10:00:00.000000"}`),
			},
		},
	}

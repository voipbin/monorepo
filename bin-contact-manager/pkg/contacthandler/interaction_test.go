	...
	tests := []struct {
	...
	}{
		{
			...
			expectInteraction: &interaction.Interaction{
				...
				CustomerID:    uuid.FromStringOrNil("aa000001-0000-0000-0000-000000000002"),
				Direction:     "incoming",
				Peer: commonaddress.Address{Type: "tel", Target: "peerTelIncoming"},
				Local: commonaddress.Address{Type: "tel", Target: "localTelIncoming"},
				ReferenceType: "call",
		...
		},
		{
			...
			expectInteraction: &interaction.Interaction{
				...
				CustomerID:    uuid.FromStringOrNil("aa000002-0000-0000-0000-000000000002"),
				Direction:     "outgoing",
				Peer: commonaddress.Address{Type: "tel", Target: "peerTelOutgoing"},
				Local: commonaddress.Address{Type: "tel", Target: "localTelOutgoing"},
				ReferenceType: "call",

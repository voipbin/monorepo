...
func Test_GetOrCreate_InsertConflict_RetrySelectsWinner(t *testing.T) {
	...
	res, err := h.GetOrCreate(ctx, customerID, commonaddress.Address{}, commonaddress.Address{Type: commonaddress.TypeTel, Target: "+15551160001"}, "call", nil)
	if err != nil {
...
func Test_GetOrCreate_InsertConflict_RaceWinnerAlsoClosedBeforeReselect(t *testing.T) {
	...
	res, err := h.GetOrCreate(ctx, customerID, commonaddress.Address{}, commonaddress.Address{Type: commonaddress.TypeTel, Target: "+15551170001"}, "call", nil)
	if err != nil {
		t.Fatalf("GetOrCreate() error = %v", err)
	}
...
func Test_GetOrCreate_InsertConflict_LoopExhaustion_Returns5xxSignal(t *testing.T) {
	...
	_, err = h.GetOrCreate(ctx, customerID, commonaddress.Address{}, commonaddress.Address{Type: commonaddress.TypeTel, Target: "+15551180001"}, "call", nil)

...
//
//	mockgen -package outplanhandler -destination ./mock_outplanhandler.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockOutplanHandlerMockRecorder) Create(ctx, customerID, name, detail, source, dialTimeout, tryInterval, maxTryCount0, maxTryCount1, maxTryCount2, maxTryCount3, maxTryCount4 any) *gomock.Call {
...
func (mr *MockOutplanHandlerMockRecorder) Delete(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOutplanHandlerMockRecorder) Get(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOutplanHandlerMockRecorder) UpdateBasicInfo(ctx, id, name, detail any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOutplanHandlerMockRecorder) UpdateDialInfo(ctx, id, source, dialTimeout, tryInterval, maxTryCount0, maxTryCount1, maxTryCount2, maxTryCount3, maxTryCount4 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

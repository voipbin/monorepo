...
func (mr *MockCacheHandlerMockRecorder) CampaignGet(ctx, id any) *gomock.Call {
...
func (mr *MockCacheHandlerMockRecorder) CampaignSet(ctx, t any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) CampaigncallGet(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) CampaigncallSet(ctx, t any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) OutplanGet(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) OutplanSet(ctx, t any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

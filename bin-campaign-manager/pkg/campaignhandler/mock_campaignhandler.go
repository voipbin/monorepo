...
//
//	mockgen -package campaignhandler -destination ./mock_campaignhandler.go -source main.go -build_flags=-mod=mod
//
...
func (mr *MockCampaignHandlerMockRecorder) Create(ctx, id, customerID, campaignType, name, detail, actions, serviceLevel, endHandle, outplanID, outdialID, queueID, nextCampaignID any) *gomock.Call {
...
func (mr *MockCampaignHandlerMockRecorder) Delete(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) EventHandleActiveflowDeleted(ctx, campaignID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) EventHandleReferenceCallHungup(ctx, campaignID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) Execute(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) Get(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) UpdateActions(ctx, id, actions any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) UpdateBasicInfo(ctx, id, name, detail, campaignType, serviceLevel, endHandle any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) UpdateNextCampaignID(ctx, id, nextCampaignID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) UpdateResourceInfo(ctx, id, outplanID, outdialID, queueID, nextCampaignID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) UpdateServiceLevel(ctx, id, serviceLevel any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCampaignHandlerMockRecorder) UpdateStatus(ctx, id, status any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
// This function also converts string UUIDs to uuid.UUID types using the Outplan model's field tags
func ConvertStringMapToFieldMap(src map[string]any) (map[Field]any, error) {
	...
	typed, err := commondatabasehandler.ConvertMapToTypedMap(src, Outplan{})
	if err != nil {

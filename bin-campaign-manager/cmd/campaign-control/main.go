...
func initCampaignHandler(sqlDB *sql.DB, cache cachehandler.CacheHandler) (campaignhandler.CampaignHandler, error) {
	...
	notifyHandler := notifyhandler.NewNotifyHandler(sockHandler, reqHandler, commonoutline.QueueNameCampaignEvent, serviceName, notifyhandler.WithGlobalTopicPublish())

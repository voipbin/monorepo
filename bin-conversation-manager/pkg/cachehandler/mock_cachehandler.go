...
func (mr *MockCacheHandlerMockRecorder) AccountSet(ctx, a interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) ConversationGet(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheHandlerMockRecorder) MessageSet(ctx, cv interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

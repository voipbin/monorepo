...
func (m *MockMessageHandler) Create(ctx context.Context, customerID, conversationID uuid.UUID, direction message.Direction, status message.Status, referenceType conversation.ReferenceType, referenceID, transactionID, text string, medias []media.Media) (*message.Message, error) {
	m.ctrl.T.Helper()

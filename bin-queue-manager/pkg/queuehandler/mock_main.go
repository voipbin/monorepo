...
// Source: pkg/queuehandler/main.go
//
// Generated by this command:
//
//	mockgen -package queuehandler -destination ./pkg/queuehandler/mock_main.go -source pkg/queuehandler/main.go -build_flags=-mod=mod
//

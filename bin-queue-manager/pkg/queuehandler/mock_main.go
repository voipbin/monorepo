...
func (m *MockQueueHandler) CountByCustomerID(ctx context.Context, customerID uuid.UUID) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockQueueHandlerMockRecorder) CountByCustomerID(ctx, customerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountByCustomerID", reflect.TypeOf((*MockQueueHandler)(nil).CountByCustomerID), ctx, customerID)
}
...
func (m *MockQueueHandler) DirectHashRegenerate(ctx context.Context, id uuid.UUID) (*queue.Queue, error) {
	m.ctrl.T.Helper()
...
func (mr *MockQueueHandlerMockRecorder) DirectHashRegenerate(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DirectHashRegenerate", reflect.TypeOf((*MockQueueHandler)(nil).DirectHashRegenerate), ctx, id)
}
...
// GetQueuesByAgent mocks base method.
func (m *MockQueueHandler) GetQueuesByAgent(ctx context.Context, arg1 agent.Agent) ([]*queue.Queue, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetQueuesByAgent", ctx, arg1)
	ret0, _ := ret[0].([]*queue.Queue)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetQueuesByAgent indicates an expected call of GetQueuesByAgent.
func (mr *MockQueueHandlerMockRecorder) GetQueuesByAgent(ctx, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetQueuesByAgent", reflect.TypeOf((*MockQueueHandler)(nil).GetQueuesByAgent), ctx, arg1)
}

...
// processV1QueuesCountByCustomerGet handles GET /v1/queues/count_by_customer
func (h *listenHandler) processV1QueuesCountByCustomerGet(ctx context.Context, m *sock.Request) (*sock.Response, error) {
	log := logrus.WithFields(logrus.Fields{
		"func":    "processV1QueuesCountByCustomerGet",
		"request": m,
	})
